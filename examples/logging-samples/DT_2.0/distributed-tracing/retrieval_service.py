"""FastAPI retrieval process that continues incoming W3C context."""
...
from splunk_ao.middleware import TracingMiddleware
...
async def retrieve_endpoint(request: RetrievalRequest) -> RetrievalResponse:
    # @log creates the real downstream workflow beneath the middleware's
    # extracted remote parent; the retriever is its local child.
