...
class TestSplunkAOADKCallback:
    @pytest.fixture
    def callback(self) -> SplunkAOADKCallback:
        return SplunkAOADKCallback(ingestion_hook=lambda r: None)
    ...
    def test_before_agent_callback(self, callback: SplunkAOADKCallback, adk_callback_context: MagicMock) -> None:
    ...
    def test_after_agent_callback(self, callback: SplunkAOADKCallback, adk_callback_context: MagicMock) -> None:
    ...
    def test_error_handling_before_agent(self, callback: SplunkAOADKCallback, adk_callback_context: MagicMock) -> None:
    ...
    def test_error_handling_after_agent_without_run_id(
        self, callback: SplunkAOADKCallback, adk_callback_context: MagicMock
    ) -> None:
        result = callback.after_agent_callback(adk_callback_context)
        assert result is None

    def test_extract_agent_input(self, callback: SplunkAOADKCallback, adk_callback_context: MagicMock) -> None:
    ...
    def test_extract_agent_input_fallback(self, callback: SplunkAOADKCallback, adk_callback_context: MagicMock) -> None:
        del adk_callback_context.parent_context

        result = callback._observer._extract_agent_input(adk_callback_context)
        assert result == "Agent invocation"

    def test_extract_llm_input(self, callback: SplunkAOADKCallback, adk_llm_request: MagicMock) -> None:
        result = callback._observer._extract_llm_input(adk_llm_request)
        assert isinstance(result, list)

    def test_extract_model_name(self, callback: SplunkAOADKCallback, adk_llm_request: MagicMock) -> None:
        result = callback._observer._extract_model_name(adk_llm_request)
        assert result == "gemini-pro"

    def test_extract_temperature(self, callback: SplunkAOADKCallback, adk_llm_request: MagicMock) -> None:
        adk_llm_request.config.temperature = 0.7

        result = callback._observer._extract_temperature(adk_llm_request)
        assert result == 0.7

    def test_extract_temperature_none(self, callback: SplunkAOADKCallback, adk_llm_request: MagicMock) -> None:
        adk_llm_request.config.temperature = None

        result = callback._observer._extract_temperature(adk_llm_request)
        assert result is None

    def test_extract_usage_metadata(self, callback: SplunkAOADKCallback, adk_llm_response: MagicMock) -> None:
...
class TestCallbackErrorHandling:
    """Consolidated error handling tests for SplunkAOADKCallback."""
...
class TestCallbackPluginCompatibility:
    ...
    def test_namespaced_attributes(self, callback: SplunkAOADKCallback) -> None:
    ...
    def test_read_only_operations(self, callback: SplunkAOADKCallback) -> None:
...
class TestAutomaticSessionMapping:
    ...
    def test_session_mapped_on_before_agent(self, callback: SplunkAOADKCallback) -> None:
    ...
    def test_session_not_remapped_for_same_session_id(self, callback: SplunkAOADKCallback) -> None:
    ...
    def test_unknown_session_id_not_mapped(self, callback: SplunkAOADKCallback) -> None:
    ...
    def test_session_updated_when_different_session_id(self, callback: SplunkAOADKCallback) -> None:
...
class TestRunConfigMetadata:
    ...
    def test_metadata_extracted_from_run_config(self, callback: SplunkAOADKCallback) -> None:
    ...
    def test_missing_run_config_results_in_empty_metadata(self, callback: SplunkAOADKCallback) -> None:
    ...
    def test_metadata_cleaned_up_after_agent_ends(self, callback: SplunkAOADKCallback) -> None:
    ...
    def test_concurrent_agents_have_isolated_metadata(self, callback: SplunkAOADKCallback) -> None:
