...
**Epic:** [HYBIM-697](https://splunk.atlassian.net/browse/HYBIM-697)  
...
Related tickets: [HYBIM-713](https://splunk.atlassian.net/browse/HYBIM-713), [HYBIM-716](https://splunk.atlassian.net/browse/HYBIM-716), [HYBIM-727](https://splunk.atlassian.net/browse/HYBIM-727)
...
Related ticket: [HYBIM-800](https://splunk.atlassian.net/browse/HYBIM-800)
...
Related ticket: [HYBIM-804](https://splunk.atlassian.net/browse/HYBIM-804)
...
## 8. Jira Tickets Covered

| Ticket | Title |
|--------|-------|
| [HYBIM-697](https://splunk.atlassian.net/browse/HYBIM-697) | Epic: Rebrand galileo-python → splunk-ao-python |
| [HYBIM-713](https://splunk.atlassian.net/browse/HYBIM-713) | Rename `GALILEO_API_KEY` → `SPLUNK_AO_API_KEY` |
| [HYBIM-716](https://splunk.atlassian.net/browse/HYBIM-716) | Rename `GALILEO_PROJECT` / `GALILEO_LOG_STREAM` → `SPLUNK_AO_*` and rename Galileo* classes to SplunkAO* |
| [HYBIM-717](https://splunk.atlassian.net/browse/HYBIM-717) | Rename main module from `galileo` to `splunk_ao` |
| [HYBIM-718](https://splunk.atlassian.net/browse/HYBIM-718) | Rename remaining env vars to `SPLUNK_AO_*` |
| [HYBIM-719](https://splunk.atlassian.net/browse/HYBIM-719) | Rebrand package metadata (name, description, author, URLs) |
...
| [HYBIM-796](https://splunk.atlassian.net/browse/HYBIM-796) | Remove redundant Python 3.10 check |
| [HYBIM-800](https://splunk.atlassian.net/browse/HYBIM-800) | Parameter name renames / remove `GalileoScorers` |
| [HYBIM-804](https://splunk.atlassian.net/browse/HYBIM-804) | Rename `X-Galileo-*` HTTP headers to `Splunk-AO-*` |
| [HYBIM-807](https://splunk.atlassian.net/browse/HYBIM-807) | Move autogenerated resources under `src/splunk_ao` and drop galileo namespace |
| [HYBIM-822](https://splunk.atlassian.net/browse/HYBIM-822) | Update example headers |
| [HYBIM-823](https://splunk.atlassian.net/browse/HYBIM-823) | Rename `galileo` → `splunk-ao` in requirements files |
