...
T = TypeVar("T", bound="ExtendedWorkflowSpanRecordFeedbackRatingInfo")


@_attrs_define
class ExtendedWorkflowSpanRecordFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_workflow_span_record_feedback_rating_info = cls()
        ...
        extended_workflow_span_record_feedback_rating_info.additional_properties = additional_properties
        return extended_workflow_span_record_feedback_rating_info
