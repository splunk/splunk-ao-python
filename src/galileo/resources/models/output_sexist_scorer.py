...
class OutputSexistScorer:
    ...
    type_: Unset | OutputSexistScorerType = OutputSexistScorerType.LUNA
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | OutputSexistScorerType
        type_ = UNSET if isinstance(_type_, Unset) else OutputSexistScorerType(_type_)
