...
T = TypeVar("T", bound="PartialExtendedWorkflowSpanRecordMetricInfoType0")


@_attrs_define
class PartialExtendedWorkflowSpanRecordMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        partial_extended_workflow_span_record_metric_info_type_0 = cls()
        ...
        partial_extended_workflow_span_record_metric_info_type_0.additional_properties = additional_properties
        return partial_extended_workflow_span_record_metric_info_type_0
