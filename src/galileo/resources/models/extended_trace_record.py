...
class ExtendedTraceRecord:
    ...
    ----------
        ...
        user_metadata (Union[Unset, ExtendedTraceRecordUserMetadata]): Metadata associated with this trace or span.
        ...
        dataset_metadata (Union[Unset, ExtendedTraceRecordDatasetMetadata]): Metadata from the dataset associated with
            this trace
        ...
        feedback_rating_info (Union[Unset, ExtendedTraceRecordFeedbackRatingInfo]): Feedback information related to the
            record
        annotations (Union[Unset, ExtendedTraceRecordAnnotations]): Annotations keyed by template ID and annotator ID
        ...
        annotation_aggregates (Union[Unset, ExtendedTraceRecordAnnotationAggregates]): Annotation aggregate information
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_files(data: object) -> Union["ExtendedTraceRecordFilesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
