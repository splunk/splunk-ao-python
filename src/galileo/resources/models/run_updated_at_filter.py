...
from ..models.run_updated_at_filter_operator import RunUpdatedAtFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="RunUpdatedAtFilter")
...
class RunUpdatedAtFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operator = RunUpdatedAtFilterOperator(d.pop("operator"))
        ...
        run_updated_at_filter = cls(operator=operator, value=value, name=name)

        run_updated_at_filter.additional_properties = d
        return run_updated_at_filter
