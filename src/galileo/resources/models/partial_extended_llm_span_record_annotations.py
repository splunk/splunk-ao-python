...
if TYPE_CHECKING:
    from ..models.partial_extended_llm_span_record_annotations_additional_property import (
        PartialExtendedLlmSpanRecordAnnotationsAdditionalProperty,
    )


T = TypeVar("T", bound="PartialExtendedLlmSpanRecordAnnotations")
...
class PartialExtendedLlmSpanRecordAnnotations:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        partial_extended_llm_span_record_annotations = cls()

        additional_properties = {}
        for prop_name, prop_dict in d.items():
            additional_property = PartialExtendedLlmSpanRecordAnnotationsAdditionalProperty.from_dict(prop_dict)

            additional_properties[prop_name] = additional_property

        partial_extended_llm_span_record_annotations.additional_properties = additional_properties
        return partial_extended_llm_span_record_annotations
