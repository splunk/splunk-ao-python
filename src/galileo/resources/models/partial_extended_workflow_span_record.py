...
class PartialExtendedWorkflowSpanRecord:
    ...
    ----------
        ...
        dataset_metadata (Union[Unset, PartialExtendedWorkflowSpanRecordDatasetMetadata]): Metadata from the dataset
        ...
        annotation_agreement (Union[Unset, PartialExtendedWorkflowSpanRecordAnnotationAgreement]): Annotation agreement
            scores keyed by template ID
        overall_annotation_agreement (Union[Unset, PartialExtendedWorkflowSpanRecordOverallAnnotationAgreement]):
    ...
    dataset_metadata: Union[Unset, "PartialExtendedWorkflowSpanRecordDatasetMetadata"] = UNSET
    ...
    annotation_agreement: Union[Unset, "PartialExtendedWorkflowSpanRecordAnnotationAgreement"] = UNSET
    overall_annotation_agreement: Union[Unset, "PartialExtendedWorkflowSpanRecordOverallAnnotationAgreement"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: Unset | PartialExtendedWorkflowSpanRecordUserMetadata
        ...
        dataset_metadata: Unset | PartialExtendedWorkflowSpanRecordDatasetMetadata
        ...
        feedback_rating_info: Unset | PartialExtendedWorkflowSpanRecordFeedbackRatingInfo
        ...
        annotations: Unset | PartialExtendedWorkflowSpanRecordAnnotations
        ...
        annotation_aggregates: Unset | PartialExtendedWorkflowSpanRecordAnnotationAggregates
        ...
        annotation_agreement: Unset | PartialExtendedWorkflowSpanRecordAnnotationAgreement
        ...
        overall_annotation_agreement: Unset | PartialExtendedWorkflowSpanRecordOverallAnnotationAgreement
        ...
        def _parse_metric_info(data: object) -> Union["PartialExtendedWorkflowSpanRecordMetricInfoType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return PartialExtendedWorkflowSpanRecordMetricInfoType0.from_dict(data)
