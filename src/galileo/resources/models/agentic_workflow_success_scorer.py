...
from ..models.agentic_workflow_success_scorer_type import AgenticWorkflowSuccessScorerType
...
T = TypeVar("T", bound="AgenticWorkflowSuccessScorer")


@_attrs_define
class AgenticWorkflowSuccessScorer:
    """
    Attributes
    ----------
        ...
        type_ (Union[Unset, AgenticWorkflowSuccessScorerType]):  Default: AgenticWorkflowSuccessScorerType.PLUS.
    ...
    type_: Unset | AgenticWorkflowSuccessScorerType = AgenticWorkflowSuccessScorerType.PLUS
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | AgenticWorkflowSuccessScorerType
        type_ = UNSET if isinstance(_type_, Unset) else AgenticWorkflowSuccessScorerType(_type_)
        ...
        return agentic_workflow_success_scorer
