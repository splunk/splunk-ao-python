...
T = TypeVar("T", bound="PartialExtendedTraceRecordMetricInfoType0")


@_attrs_define
class PartialExtendedTraceRecordMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        partial_extended_trace_record_metric_info_type_0 = cls()
        ...
        partial_extended_trace_record_metric_info_type_0.additional_properties = additional_properties
        return partial_extended_trace_record_metric_info_type_0
