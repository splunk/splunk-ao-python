...
T = TypeVar("T", bound="ExtendedAgentSpanRecordAnnotationAggregates")


@_attrs_define
class ExtendedAgentSpanRecordAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_agent_span_record_annotation_aggregates = cls()
        ...
        extended_agent_span_record_annotation_aggregates.additional_properties = additional_properties
        return extended_agent_span_record_annotation_aggregates
