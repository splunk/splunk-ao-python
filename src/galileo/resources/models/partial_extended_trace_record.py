...
if TYPE_CHECKING:
    ...
    from ..models.partial_extended_trace_record_annotation_aggregates import (
        PartialExtendedTraceRecordAnnotationAggregates,
    )
    from ..models.partial_extended_trace_record_annotation_agreement import (
        PartialExtendedTraceRecordAnnotationAgreement,
    )
    from ..models.partial_extended_trace_record_annotations import PartialExtendedTraceRecordAnnotations
    from ..models.partial_extended_trace_record_dataset_metadata import PartialExtendedTraceRecordDatasetMetadata
...
T = TypeVar("T", bound="PartialExtendedTraceRecord")
...
class PartialExtendedTraceRecord:
    ...
    ----------
        ...
        overall_annotation_agreement (Union[Unset, PartialExtendedTraceRecordOverallAnnotationAgreement]): Average
    ...
    trace_id: None | UUID | Unset = UNSET
    ...
    overall_annotation_agreement: Union[Unset, "PartialExtendedTraceRecordOverallAnnotationAgreement"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.partial_extended_trace_record_annotations import PartialExtendedTraceRecordAnnotations
        from ..models.partial_extended_trace_record_dataset_metadata import PartialExtendedTraceRecordDatasetMetadata
        from ..models.partial_extended_trace_record_feedback_rating_info import (
        ...
        user_metadata: Unset | PartialExtendedTraceRecordUserMetadata
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = PartialExtendedTraceRecordUserMetadata.from_dict(_user_metadata)
        ...
        dataset_metadata: Unset | PartialExtendedTraceRecordDatasetMetadata
        ...
        def _parse_trace_id(data: object) -> None | UUID | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        feedback_rating_info: Unset | PartialExtendedTraceRecordFeedbackRatingInfo
        ...
        annotations: Unset | PartialExtendedTraceRecordAnnotations
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = PartialExtendedTraceRecordAnnotations.from_dict(_annotations)
        ...
        annotation_aggregates: Unset | PartialExtendedTraceRecordAnnotationAggregates
        ...
        annotation_agreement: Unset | PartialExtendedTraceRecordAnnotationAgreement
        ...
        overall_annotation_agreement: Unset | PartialExtendedTraceRecordOverallAnnotationAgreement
        ...
        def _parse_metric_info(data: object) -> Union["PartialExtendedTraceRecordMetricInfoType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return PartialExtendedTraceRecordMetricInfoType0.from_dict(data)
        ...
        def _parse_files(data: object) -> Union["PartialExtendedTraceRecordFilesType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return PartialExtendedTraceRecordFilesType0.from_dict(data)
        ...
        return partial_extended_trace_record
