...
if TYPE_CHECKING:
    ...
    from ..models.partial_extended_tool_span_record_annotation_aggregates import (
        PartialExtendedToolSpanRecordAnnotationAggregates,
    )
    from ..models.partial_extended_tool_span_record_annotation_agreement import (
        PartialExtendedToolSpanRecordAnnotationAgreement,
    )
    from ..models.partial_extended_tool_span_record_annotations import PartialExtendedToolSpanRecordAnnotations
    from ..models.partial_extended_tool_span_record_dataset_metadata import PartialExtendedToolSpanRecordDatasetMetadata
    from ..models.partial_extended_tool_span_record_feedback_rating_info import (
        PartialExtendedToolSpanRecordFeedbackRatingInfo,
    )
    from ..models.partial_extended_tool_span_record_files_type_0 import PartialExtendedToolSpanRecordFilesType0
    from ..models.partial_extended_tool_span_record_metric_info_type_0 import (
        PartialExtendedToolSpanRecordMetricInfoType0,
    )
    from ..models.partial_extended_tool_span_record_overall_annotation_agreement import (
        PartialExtendedToolSpanRecordOverallAnnotationAgreement,
    )
    from ..models.partial_extended_tool_span_record_user_metadata import PartialExtendedToolSpanRecordUserMetadata


T = TypeVar("T", bound="PartialExtendedToolSpanRecord")


@_attrs_define
class PartialExtendedToolSpanRecord:
    """
    Attributes
    ----------
        ...
        user_metadata (Union[Unset, PartialExtendedToolSpanRecordUserMetadata]): Metadata associated with this trace or
            span.
        ...
        dataset_metadata (Union[Unset, PartialExtendedToolSpanRecordDatasetMetadata]): Metadata from the dataset
        ...
        feedback_rating_info (Union[Unset, PartialExtendedToolSpanRecordFeedbackRatingInfo]): Feedback information
            related to the record
        annotations (Union[Unset, PartialExtendedToolSpanRecordAnnotations]): Annotations keyed by template ID and
            annotator ID
        ...
        annotation_aggregates (Union[Unset, PartialExtendedToolSpanRecordAnnotationAggregates]): Annotation aggregate
            information keyed by template ID
        annotation_agreement (Union[Unset, PartialExtendedToolSpanRecordAnnotationAgreement]): Annotation agreement
            scores keyed by template ID
        overall_annotation_agreement (Union[Unset, PartialExtendedToolSpanRecordOverallAnnotationAgreement]): Average
        ...
        metric_info (Union['PartialExtendedToolSpanRecordMetricInfoType0', None, Unset]): Detailed information about the
            metrics associated with this trace or span
        files (Union['PartialExtendedToolSpanRecordFilesType0', None, Unset]): File metadata keyed by file ID for files
    ...
    user_metadata: Union[Unset, "PartialExtendedToolSpanRecordUserMetadata"] = UNSET
    ...
    dataset_metadata: Union[Unset, "PartialExtendedToolSpanRecordDatasetMetadata"] = UNSET
    ...
    feedback_rating_info: Union[Unset, "PartialExtendedToolSpanRecordFeedbackRatingInfo"] = UNSET
    annotations: Union[Unset, "PartialExtendedToolSpanRecordAnnotations"] = UNSET
    file_ids: Unset | list[str] = UNSET
    file_modalities: Unset | list[ContentModality] = UNSET
    annotation_aggregates: Union[Unset, "PartialExtendedToolSpanRecordAnnotationAggregates"] = UNSET
    annotation_agreement: Union[Unset, "PartialExtendedToolSpanRecordAnnotationAgreement"] = UNSET
    overall_annotation_agreement: Union[Unset, "PartialExtendedToolSpanRecordOverallAnnotationAgreement"] = UNSET
    annotation_queue_ids: Unset | list[str] = UNSET
    metric_info: Union["PartialExtendedToolSpanRecordMetricInfoType0", None, Unset] = UNSET
    files: Union["PartialExtendedToolSpanRecordFilesType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metric_info, Unset):
            metric_info = UNSET
        elif isinstance(self.metric_info, PartialExtendedToolSpanRecordMetricInfoType0):
        ...
        if isinstance(self.files, Unset):
            files = UNSET
        elif isinstance(self.files, PartialExtendedToolSpanRecordFilesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.partial_extended_tool_span_record_annotations import PartialExtendedToolSpanRecordAnnotations
        from ..models.partial_extended_tool_span_record_dataset_metadata import (
        ...
        user_metadata: Unset | PartialExtendedToolSpanRecordUserMetadata
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = PartialExtendedToolSpanRecordUserMetadata.from_dict(_user_metadata)
        ...
        dataset_metadata: Unset | PartialExtendedToolSpanRecordDatasetMetadata
        if isinstance(_dataset_metadata, Unset):
            dataset_metadata = UNSET
        else:
            dataset_metadata = PartialExtendedToolSpanRecordDatasetMetadata.from_dict(_dataset_metadata)
        ...
        feedback_rating_info: Unset | PartialExtendedToolSpanRecordFeedbackRatingInfo
        if isinstance(_feedback_rating_info, Unset):
            feedback_rating_info = UNSET
        else:
            feedback_rating_info = PartialExtendedToolSpanRecordFeedbackRatingInfo.from_dict(_feedback_rating_info)

        _annotations = d.pop("annotations", UNSET)
        annotations: Unset | PartialExtendedToolSpanRecordAnnotations
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = PartialExtendedToolSpanRecordAnnotations.from_dict(_annotations)
        ...
        annotation_aggregates: Unset | PartialExtendedToolSpanRecordAnnotationAggregates
        if isinstance(_annotation_aggregates, Unset):
            annotation_aggregates = UNSET
        else:
            annotation_aggregates = PartialExtendedToolSpanRecordAnnotationAggregates.from_dict(_annotation_aggregates)

        _annotation_agreement = d.pop("annotation_agreement", UNSET)
        annotation_agreement: Unset | PartialExtendedToolSpanRecordAnnotationAgreement
        if isinstance(_annotation_agreement, Unset):
            annotation_agreement = UNSET
        else:
            annotation_agreement = PartialExtendedToolSpanRecordAnnotationAgreement.from_dict(_annotation_agreement)

        _overall_annotation_agreement = d.pop("overall_annotation_agreement", UNSET)
        overall_annotation_agreement: Unset | PartialExtendedToolSpanRecordOverallAnnotationAgreement
        if isinstance(_overall_annotation_agreement, Unset):
            overall_annotation_agreement = UNSET
        else:
            overall_annotation_agreement = PartialExtendedToolSpanRecordOverallAnnotationAgreement.from_dict(
                _overall_annotation_agreement
            )

        annotation_queue_ids = cast(list[str], d.pop("annotation_queue_ids", UNSET))

        def _parse_metric_info(data: object) -> Union["PartialExtendedToolSpanRecordMetricInfoType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return PartialExtendedToolSpanRecordMetricInfoType0.from_dict(data)

            except:  # noqa: E722
                pass
            return cast(Union["PartialExtendedToolSpanRecordMetricInfoType0", None, Unset], data)

        metric_info = _parse_metric_info(d.pop("metric_info", UNSET))

        def _parse_files(data: object) -> Union["PartialExtendedToolSpanRecordFilesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return PartialExtendedToolSpanRecordFilesType0.from_dict(data)

            except:  # noqa: E722
                pass
            return cast(Union["PartialExtendedToolSpanRecordFilesType0", None, Unset], data)
        ...
        partial_extended_tool_span_record = cls(
            type_=type_,
            input_=input_,
        ...
        partial_extended_tool_span_record.additional_properties = d
        return partial_extended_tool_span_record
