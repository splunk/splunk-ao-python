    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_aggregates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedAgenticSessionSuccessGPTScorerAggregatesType0.from_dict(data)
        ...
        def _parse_extra(data: object) -> Union["CustomizedAgenticSessionSuccessGPTScorerExtraType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedAgenticSessionSuccessGPTScorerExtraType0.from_dict(data)
        ...
        chainpoll_template: Unset | AgenticSessionSuccessTemplate
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType1.from_dict(data)
