...
T = TypeVar("T", bound="ExperimentResponseAggregateFeedback")
...
class ExperimentResponseAggregateFeedback:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        experiment_response_aggregate_feedback.additional_properties = additional_properties
        return experiment_response_aggregate_feedback
