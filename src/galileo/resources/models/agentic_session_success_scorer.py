...
class AgenticSessionSuccessScorer:
    ...
    type_: Unset | AgenticSessionSuccessScorerType = AgenticSessionSuccessScorerType.PLUS
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | AgenticSessionSuccessScorerType
        type_ = UNSET if isinstance(_type_, Unset) else AgenticSessionSuccessScorerType(_type_)
