...
class PartialExtendedSessionRecord:
    ...
    ----------
        ...
        user_metadata (Union[Unset, PartialExtendedSessionRecordUserMetadata]): Metadata associated with this trace or
            span.
        ...
        dataset_metadata (Union[Unset, PartialExtendedSessionRecordDatasetMetadata]): Metadata from the dataset
            associated with this trace
        id (Union[None, UUID, Unset]): Galileo ID of the session
        ...
        feedback_rating_info (Union[Unset, PartialExtendedSessionRecordFeedbackRatingInfo]): Feedback information
            related to the record
        annotations (Union[Unset, PartialExtendedSessionRecordAnnotations]): Annotations keyed by template ID and
            annotator ID
        ...
        annotation_aggregates (Union[Unset, PartialExtendedSessionRecordAnnotationAggregates]): Annotation aggregate
            information keyed by template ID
        annotation_agreement (Union[Unset, PartialExtendedSessionRecordAnnotationAgreement]): Annotation agreement
            scores keyed by template ID
        overall_annotation_agreement (Union[Unset, PartialExtendedSessionRecordOverallAnnotationAgreement]): Average
        ...
        metric_info (Union['PartialExtendedSessionRecordMetricInfoType0', None, Unset]): Detailed information about the
            metrics associated with this trace or span
        files (Union['PartialExtendedSessionRecordFilesType0', None, Unset]): File metadata keyed by file ID for files
    ...
    annotation_agreement: Union[Unset, "PartialExtendedSessionRecordAnnotationAgreement"] = UNSET
    overall_annotation_agreement: Union[Unset, "PartialExtendedSessionRecordOverallAnnotationAgreement"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        annotation_agreement: Unset | PartialExtendedSessionRecordAnnotationAgreement
        ...
        overall_annotation_agreement: Unset | PartialExtendedSessionRecordOverallAnnotationAgreement
        ...
        def _parse_metric_info(data: object) -> Union["PartialExtendedSessionRecordMetricInfoType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["PartialExtendedSessionRecordMetricInfoType0", None, Unset], data)

        metric_info = _parse_metric_info(d.pop("metric_info", UNSET))

        def _parse_files(data: object) -> Union["PartialExtendedSessionRecordFilesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["PartialExtendedSessionRecordFilesType0", None, Unset], data)
