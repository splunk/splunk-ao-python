...
T = TypeVar("T", bound="ExtendedControlSpanRecordFeedbackRatingInfo")


@_attrs_define
class ExtendedControlSpanRecordFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_control_span_record_feedback_rating_info = cls()
        ...
        extended_control_span_record_feedback_rating_info.additional_properties = additional_properties
        return extended_control_span_record_feedback_rating_info
