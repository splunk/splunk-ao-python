...
T = TypeVar("T", bound="ExtendedSessionRecordAnnotationAggregates")


@_attrs_define
class ExtendedSessionRecordAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_session_record_annotation_aggregates = cls()
        ...
        extended_session_record_annotation_aggregates.additional_properties = additional_properties
        return extended_session_record_annotation_aggregates
