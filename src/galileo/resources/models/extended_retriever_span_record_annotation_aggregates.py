...
T = TypeVar("T", bound="ExtendedRetrieverSpanRecordAnnotationAggregates")


@_attrs_define
class ExtendedRetrieverSpanRecordAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_retriever_span_record_annotation_aggregates = cls()
        ...
        extended_retriever_span_record_annotation_aggregates.additional_properties = additional_properties
        return extended_retriever_span_record_annotation_aggregates
