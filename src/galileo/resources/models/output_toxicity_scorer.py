...
from ..models.output_toxicity_scorer_type import OutputToxicityScorerType
...
T = TypeVar("T", bound="OutputToxicityScorer")


@_attrs_define
class OutputToxicityScorer:
    """
    Attributes
    ----------
        ...
        type_ (Union[Unset, OutputToxicityScorerType]):  Default: OutputToxicityScorerType.LUNA.
    ...
    type_: Unset | OutputToxicityScorerType = OutputToxicityScorerType.LUNA
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | OutputToxicityScorerType
        type_ = UNSET if isinstance(_type_, Unset) else OutputToxicityScorerType(_type_)
