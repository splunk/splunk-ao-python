...
from ..models.prompt_injection_scorer_type import PromptInjectionScorerType
...
T = TypeVar("T", bound="PromptInjectionScorer")
...
class PromptInjectionScorer:
    ...
    ----------
        ...
        type_ (Union[Unset, PromptInjectionScorerType]):  Default: PromptInjectionScorerType.LUNA.
    ...
    type_: Unset | PromptInjectionScorerType = PromptInjectionScorerType.LUNA
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | PromptInjectionScorerType
        type_ = UNSET if isinstance(_type_, Unset) else PromptInjectionScorerType(_type_)
