...
class ExtendedLlmSpanRecord:
    ...
    ----------
        ...
        feedback_rating_info (Union[Unset, ExtendedLlmSpanRecordFeedbackRatingInfo]): Feedback information related to
            the record
        annotations (Union[Unset, ExtendedLlmSpanRecordAnnotations]): Annotations keyed by template ID and annotator ID
        ...
        annotation_aggregates (Union[Unset, ExtendedLlmSpanRecordAnnotationAggregates]): Annotation aggregate
            information keyed by template ID
        annotation_agreement (Union[Unset, ExtendedLlmSpanRecordAnnotationAgreement]): Annotation agreement scores keyed
            by template ID
        overall_annotation_agreement (Union[Unset, ExtendedLlmSpanRecordOverallAnnotationAgreement]): Average annotation
        ...
        files (Union['ExtendedLlmSpanRecordFilesType0', None, Unset]): File metadata keyed by file ID for files
    ...
    annotations: Union[Unset, "ExtendedLlmSpanRecordAnnotations"] = UNSET
    file_ids: Unset | list[str] = UNSET
    file_modalities: Unset | list[ContentModality] = UNSET
    annotation_aggregates: Union[Unset, "ExtendedLlmSpanRecordAnnotationAggregates"] = UNSET
    annotation_agreement: Union[Unset, "ExtendedLlmSpanRecordAnnotationAgreement"] = UNSET
    overall_annotation_agreement: Union[Unset, "ExtendedLlmSpanRecordOverallAnnotationAgreement"] = UNSET
    annotation_queue_ids: Unset | list[str] = UNSET
    metric_info: Union["ExtendedLlmSpanRecordMetricInfoType0", None, Unset] = UNSET
    files: Union["ExtendedLlmSpanRecordFilesType0", None, Unset] = UNSET
    is_complete: Unset | bool = True
    step_number: None | Unset | int = UNSET
    tools: None | Unset | list["ExtendedLlmSpanRecordToolsType0Item"] = UNSET
    events: (
        None
        | Unset
        | list[
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.files, Unset):
            files = UNSET
        elif isinstance(self.files, ExtendedLlmSpanRecordFilesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: Unset | ExtendedLlmSpanRecordUserMetadata
        ...
        dataset_metadata: Unset | ExtendedLlmSpanRecordDatasetMetadata
        ...
        feedback_rating_info: Unset | ExtendedLlmSpanRecordFeedbackRatingInfo
        ...
        annotations: Unset | ExtendedLlmSpanRecordAnnotations
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = ExtendedLlmSpanRecordAnnotations.from_dict(_annotations)
        ...
        annotation_aggregates: Unset | ExtendedLlmSpanRecordAnnotationAggregates
        ...
        annotation_agreement: Unset | ExtendedLlmSpanRecordAnnotationAgreement
        ...
        overall_annotation_agreement: Unset | ExtendedLlmSpanRecordOverallAnnotationAgreement
        ...
        def _parse_files(data: object) -> Union["ExtendedLlmSpanRecordFilesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["ExtendedLlmSpanRecordFilesType0", None, Unset], data)
        ...
        def _parse_tools(data: object) -> None | Unset | list["ExtendedLlmSpanRecordToolsType0Item"]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | Unset | list["ExtendedLlmSpanRecordToolsType0Item"], data)
