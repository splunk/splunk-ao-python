...
T = TypeVar("T", bound="ExtendedTraceRecordWithChildrenAnnotationAggregates")


@_attrs_define
class ExtendedTraceRecordWithChildrenAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_trace_record_with_children_annotation_aggregates = cls()
        ...
        extended_trace_record_with_children_annotation_aggregates.additional_properties = additional_properties
        return extended_trace_record_with_children_annotation_aggregates
