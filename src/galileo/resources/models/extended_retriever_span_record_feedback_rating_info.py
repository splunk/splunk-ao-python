...
T = TypeVar("T", bound="ExtendedRetrieverSpanRecordFeedbackRatingInfo")


@_attrs_define
class ExtendedRetrieverSpanRecordFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_retriever_span_record_feedback_rating_info = cls()
        ...
        extended_retriever_span_record_feedback_rating_info.additional_properties = additional_properties
        return extended_retriever_span_record_feedback_rating_info
