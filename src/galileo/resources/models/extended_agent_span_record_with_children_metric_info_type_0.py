...
T = TypeVar("T", bound="ExtendedAgentSpanRecordWithChildrenMetricInfoType0")


@_attrs_define
class ExtendedAgentSpanRecordWithChildrenMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_agent_span_record_with_children_metric_info_type_0 = cls()
        ...
        extended_agent_span_record_with_children_metric_info_type_0.additional_properties = additional_properties
        return extended_agent_span_record_with_children_metric_info_type_0
