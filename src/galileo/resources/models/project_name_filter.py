...
from ..models.project_name_filter_operator import ProjectNameFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectNameFilter")
...
class ProjectNameFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_name_filter = cls(operator=operator, value=value, name=name, case_sensitive=case_sensitive)
