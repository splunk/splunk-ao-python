...
if TYPE_CHECKING:
    ...
    from ..models.extended_agent_span_record_with_children_annotation_aggregates import (
        ExtendedAgentSpanRecordWithChildrenAnnotationAggregates,
    )
    from ..models.extended_agent_span_record_with_children_annotation_agreement import (
        ExtendedAgentSpanRecordWithChildrenAnnotationAgreement,
    )
    from ..models.extended_agent_span_record_with_children_annotations import (
        ExtendedAgentSpanRecordWithChildrenAnnotations,
    )
    from ..models.extended_agent_span_record_with_children_dataset_metadata import (
        ExtendedAgentSpanRecordWithChildrenDatasetMetadata,
    )
    from ..models.extended_agent_span_record_with_children_feedback_rating_info import (
        ExtendedAgentSpanRecordWithChildrenFeedbackRatingInfo,
    )
    from ..models.extended_agent_span_record_with_children_files_type_0 import (
        ExtendedAgentSpanRecordWithChildrenFilesType0,
    )
    from ..models.extended_agent_span_record_with_children_metric_info_type_0 import (
        ExtendedAgentSpanRecordWithChildrenMetricInfoType0,
    )
    from ..models.extended_agent_span_record_with_children_overall_annotation_agreement import (
        ExtendedAgentSpanRecordWithChildrenOverallAnnotationAgreement,
    )
    from ..models.extended_agent_span_record_with_children_user_metadata import (
...
T = TypeVar("T", bound="ExtendedAgentSpanRecordWithChildren")
...
class ExtendedAgentSpanRecordWithChildren:
    ...
    ----------
        ...
        user_metadata (Union[Unset, ExtendedAgentSpanRecordWithChildrenUserMetadata]): Metadata associated with this
            trace or span.
        ...
        dataset_metadata (Union[Unset, ExtendedAgentSpanRecordWithChildrenDatasetMetadata]): Metadata from the dataset
        ...
        feedback_rating_info (Union[Unset, ExtendedAgentSpanRecordWithChildrenFeedbackRatingInfo]): Feedback information
            related to the record
        annotations (Union[Unset, ExtendedAgentSpanRecordWithChildrenAnnotations]): Annotations keyed by template ID and
            annotator ID
        ...
        annotation_aggregates (Union[Unset, ExtendedAgentSpanRecordWithChildrenAnnotationAggregates]): Annotation
            aggregate information keyed by template ID
        annotation_agreement (Union[Unset, ExtendedAgentSpanRecordWithChildrenAnnotationAgreement]): Annotation
            agreement scores keyed by template ID
        overall_annotation_agreement (Union[Unset, ExtendedAgentSpanRecordWithChildrenOverallAnnotationAgreement]):
        ...
        metric_info (Union['ExtendedAgentSpanRecordWithChildrenMetricInfoType0', None, Unset]): Detailed information
            about the metrics associated with this trace or span
        files (Union['ExtendedAgentSpanRecordWithChildrenFilesType0', None, Unset]): File metadata keyed by file ID for
    ...
    user_metadata: Union[Unset, "ExtendedAgentSpanRecordWithChildrenUserMetadata"] = UNSET
    ...
    dataset_metadata: Union[Unset, "ExtendedAgentSpanRecordWithChildrenDatasetMetadata"] = UNSET
    ...
    feedback_rating_info: Union[Unset, "ExtendedAgentSpanRecordWithChildrenFeedbackRatingInfo"] = UNSET
    annotations: Union[Unset, "ExtendedAgentSpanRecordWithChildrenAnnotations"] = UNSET
    file_ids: Unset | list[str] = UNSET
    file_modalities: Unset | list[ContentModality] = UNSET
    annotation_aggregates: Union[Unset, "ExtendedAgentSpanRecordWithChildrenAnnotationAggregates"] = UNSET
    annotation_agreement: Union[Unset, "ExtendedAgentSpanRecordWithChildrenAnnotationAgreement"] = UNSET
    overall_annotation_agreement: Union[Unset, "ExtendedAgentSpanRecordWithChildrenOverallAnnotationAgreement"] = UNSET
    annotation_queue_ids: Unset | list[str] = UNSET
    metric_info: Union["ExtendedAgentSpanRecordWithChildrenMetricInfoType0", None, Unset] = UNSET
    files: Union["ExtendedAgentSpanRecordWithChildrenFilesType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metric_info, Unset):
            metric_info = UNSET
        elif isinstance(self.metric_info, ExtendedAgentSpanRecordWithChildrenMetricInfoType0):
        ...
        if isinstance(self.files, Unset):
            files = UNSET
        elif isinstance(self.files, ExtendedAgentSpanRecordWithChildrenFilesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: Unset | ExtendedAgentSpanRecordWithChildrenUserMetadata
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = ExtendedAgentSpanRecordWithChildrenUserMetadata.from_dict(_user_metadata)
        ...
        dataset_metadata: Unset | ExtendedAgentSpanRecordWithChildrenDatasetMetadata
        if isinstance(_dataset_metadata, Unset):
            dataset_metadata = UNSET
        else:
            dataset_metadata = ExtendedAgentSpanRecordWithChildrenDatasetMetadata.from_dict(_dataset_metadata)
        ...
        feedback_rating_info: Unset | ExtendedAgentSpanRecordWithChildrenFeedbackRatingInfo
        if isinstance(_feedback_rating_info, Unset):
            feedback_rating_info = UNSET
        else:
            feedback_rating_info = ExtendedAgentSpanRecordWithChildrenFeedbackRatingInfo.from_dict(
                _feedback_rating_info
            )

        _annotations = d.pop("annotations", UNSET)
        annotations: Unset | ExtendedAgentSpanRecordWithChildrenAnnotations
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = ExtendedAgentSpanRecordWithChildrenAnnotations.from_dict(_annotations)
        ...
        annotation_aggregates: Unset | ExtendedAgentSpanRecordWithChildrenAnnotationAggregates
        if isinstance(_annotation_aggregates, Unset):
            annotation_aggregates = UNSET
        else:
            annotation_aggregates = ExtendedAgentSpanRecordWithChildrenAnnotationAggregates.from_dict(
                _annotation_aggregates
            )

        _annotation_agreement = d.pop("annotation_agreement", UNSET)
        annotation_agreement: Unset | ExtendedAgentSpanRecordWithChildrenAnnotationAgreement
        if isinstance(_annotation_agreement, Unset):
            annotation_agreement = UNSET
        else:
            annotation_agreement = ExtendedAgentSpanRecordWithChildrenAnnotationAgreement.from_dict(
                _annotation_agreement
            )

        _overall_annotation_agreement = d.pop("overall_annotation_agreement", UNSET)
        overall_annotation_agreement: Unset | ExtendedAgentSpanRecordWithChildrenOverallAnnotationAgreement
        if isinstance(_overall_annotation_agreement, Unset):
            overall_annotation_agreement = UNSET
        else:
            overall_annotation_agreement = ExtendedAgentSpanRecordWithChildrenOverallAnnotationAgreement.from_dict(
                _overall_annotation_agreement
            )

        annotation_queue_ids = cast(list[str], d.pop("annotation_queue_ids", UNSET))

        def _parse_metric_info(
            data: object,
        ) -> Union["ExtendedAgentSpanRecordWithChildrenMetricInfoType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return ExtendedAgentSpanRecordWithChildrenMetricInfoType0.from_dict(data)

            except:  # noqa: E722
                pass
            return cast(Union["ExtendedAgentSpanRecordWithChildrenMetricInfoType0", None, Unset], data)

        metric_info = _parse_metric_info(d.pop("metric_info", UNSET))

        def _parse_files(data: object) -> Union["ExtendedAgentSpanRecordWithChildrenFilesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return ExtendedAgentSpanRecordWithChildrenFilesType0.from_dict(data)

            except:  # noqa: E722
                pass
            return cast(Union["ExtendedAgentSpanRecordWithChildrenFilesType0", None, Unset], data)
        ...
        return extended_agent_span_record_with_children
