    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_aggregates(data: object) -> Union["CustomizedSexistGPTScorerAggregatesType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedSexistGPTScorerAggregatesType0.from_dict(data)
        ...
        def _parse_extra(data: object) -> Union["CustomizedSexistGPTScorerExtraType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedSexistGPTScorerExtraType0.from_dict(data)
        ...
        chainpoll_template: Unset | SexistTemplate
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedSexistGPTScorerClassNameToVocabIxType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedSexistGPTScorerClassNameToVocabIxType1.from_dict(data)
