    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_aggregates(data: object) -> Union["CustomizedPromptInjectionGPTScorerAggregatesType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedPromptInjectionGPTScorerAggregatesType0.from_dict(data)
        ...
        def _parse_extra(data: object) -> Union["CustomizedPromptInjectionGPTScorerExtraType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedPromptInjectionGPTScorerExtraType0.from_dict(data)
        ...
        chainpoll_template: Unset | PromptInjectionTemplate
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedPromptInjectionGPTScorerClassNameToVocabIxType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedPromptInjectionGPTScorerClassNameToVocabIxType1.from_dict(data)
