...
T = TypeVar("T", bound="ExtendedLlmSpanRecordMetricInfoType0")


@_attrs_define
class ExtendedLlmSpanRecordMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_llm_span_record_metric_info_type_0 = cls()
        ...
        extended_llm_span_record_metric_info_type_0.additional_properties = additional_properties
        return extended_llm_span_record_metric_info_type_0
