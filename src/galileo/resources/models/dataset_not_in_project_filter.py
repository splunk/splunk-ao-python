...
T = TypeVar("T", bound="DatasetNotInProjectFilter")
...
class DatasetNotInProjectFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_not_in_project_filter = cls(value=value, name=name)

        dataset_not_in_project_filter.additional_properties = d
        return dataset_not_in_project_filter
