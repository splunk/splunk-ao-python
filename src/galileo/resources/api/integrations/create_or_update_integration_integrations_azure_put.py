...
from ... import errors
from ...models.azure_integration_create import AzureIntegrationCreate
from ...models.http_validation_error import HTTPValidationError
from ...models.integration_db import IntegrationDB
from ...types import Response


def _get_kwargs(*, body: AzureIntegrationCreate) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {"method": RequestMethod.PUT, "return_raw_response": True, "path": "/integrations/azure"}
