...
from ...models.integration_select_request import IntegrationSelectRequest
from ...types import Response


def _get_kwargs(*, body: IntegrationSelectRequest) -> dict[str, Any]:
...
def sync_detailed(
    *, client: ApiClient, body: IntegrationSelectRequest
...
def sync(*, client: ApiClient, body: IntegrationSelectRequest) -> HTTPValidationError | IntegrationDB | None:
    """Select Integration.
...
async def asyncio(*, client: ApiClient, body: IntegrationSelectRequest) -> HTTPValidationError | IntegrationDB | None:
    """Select Integration.
