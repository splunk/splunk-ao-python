...
def sync(*, client: ApiClient, body: OpenAIIntegrationCreate) -> HTTPValidationError | IntegrationDB | None:
    """Create or update OpenAI integration.
...
async def asyncio(*, client: ApiClient, body: OpenAIIntegrationCreate) -> HTTPValidationError | IntegrationDB | None:
    """Create or update OpenAI integration.
