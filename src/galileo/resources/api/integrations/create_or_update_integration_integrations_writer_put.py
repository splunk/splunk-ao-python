...
def _get_kwargs(*, body: WriterIntegrationCreate) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {"method": RequestMethod.PUT, "return_raw_response": True, "path": "/integrations/writer"}
...
def sync(*, client: ApiClient, body: WriterIntegrationCreate) -> HTTPValidationError | IntegrationDB | None:
    """Create or update Writer integration.
...
async def asyncio(*, client: ApiClient, body: WriterIntegrationCreate) -> HTTPValidationError | IntegrationDB | None:
    """Create or update Writer integration.
