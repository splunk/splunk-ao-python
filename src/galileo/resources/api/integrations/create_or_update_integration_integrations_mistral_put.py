...
from ...models.mistral_integration_create import MistralIntegrationCreate
from ...types import Response


def _get_kwargs(*, body: MistralIntegrationCreate) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.PUT,
        "return_raw_response": True,
        "path": "/integrations/mistral",
    }
...
def sync_detailed(
    *, client: ApiClient, body: MistralIntegrationCreate
...
def sync(*, client: ApiClient, body: MistralIntegrationCreate) -> HTTPValidationError | IntegrationDB | None:
    """Create or update Mistral integration.
...
async def asyncio(*, client: ApiClient, body: MistralIntegrationCreate) -> HTTPValidationError | IntegrationDB | None:
    """Create or update Mistral integration.
