...
def _get_kwargs() -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {"method": RequestMethod.GET, "return_raw_response": True, "path": "/integrations"}
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> list["IntegrationDB"]:
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = IntegrationDB.from_dict(response_200_item_data)
