...
from ...models.vegas_gateway_integration_create import VegasGatewayIntegrationCreate
from ...types import Response


def _get_kwargs(*, body: VegasGatewayIntegrationCreate) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.PUT,
        "return_raw_response": True,
        "path": "/integrations/vegas_gateway",
    }
