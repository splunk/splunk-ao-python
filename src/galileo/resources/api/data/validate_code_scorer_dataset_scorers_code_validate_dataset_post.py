...
from ... import errors
from ...models.body_validate_code_scorer_dataset_scorers_code_validate_dataset_post import (
    BodyValidateCodeScorerDatasetScorersCodeValidateDatasetPost,
)
from ...models.http_validation_error import HTTPValidationError
from ...models.validate_code_scorer_dataset_response import ValidateCodeScorerDatasetResponse
from ...types import Response


def _get_kwargs(*, body: BodyValidateCodeScorerDatasetScorersCodeValidateDatasetPost) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/scorers/code/validate/dataset",
    }
...
def _parse_response(
    *, client: ApiClient, response: httpx.Response
    ...
    if response.status_code == 200:
        return ValidateCodeScorerDatasetResponse.from_dict(response.json())
...
def sync(
    *, client: ApiClient, body: BodyValidateCodeScorerDatasetScorersCodeValidateDatasetPost
) -> HTTPValidationError | ValidateCodeScorerDatasetResponse | None:
    """Validate Code Scorer Dataset.
