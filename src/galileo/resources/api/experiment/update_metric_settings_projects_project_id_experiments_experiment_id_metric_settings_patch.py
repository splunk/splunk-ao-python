...
from ...models.metric_settings_request import MetricSettingsRequest
from ...models.metric_settings_response import MetricSettingsResponse
from ...types import Response


def _get_kwargs(project_id: str, experiment_id: str, *, body: MetricSettingsRequest) -> dict[str, Any]:
