...
from ...models.log_records_query_count_request import LogRecordsQueryCountRequest
from ...models.log_records_query_count_response import LogRecordsQueryCountResponse
from ...types import Response


def _get_kwargs(project_id: str, *, body: LogRecordsQueryCountRequest) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/projects/{project_id}/spans/count".format(project_id=project_id),
    }
