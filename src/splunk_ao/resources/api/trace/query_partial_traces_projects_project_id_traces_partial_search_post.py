...
from ...models.log_records_partial_query_request import LogRecordsPartialQueryRequest
from ...models.log_records_partial_query_response import LogRecordsPartialQueryResponse
from ...types import Response


def _get_kwargs(project_id: str, *, body: LogRecordsPartialQueryRequest) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/projects/{project_id}/traces/partial_search".format(project_id=project_id),
    }
