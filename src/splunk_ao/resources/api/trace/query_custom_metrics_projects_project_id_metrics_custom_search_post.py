...
from ...models.log_records_custom_metrics_query_request import LogRecordsCustomMetricsQueryRequest
from ...models.log_records_metrics_response import LogRecordsMetricsResponse
from ...types import Response


def _get_kwargs(project_id: str, *, body: LogRecordsCustomMetricsQueryRequest) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/projects/{project_id}/metrics/custom_search".format(project_id=project_id),
    }
