...
from ... import errors
from ...models.databricks_integration_create import DatabricksIntegrationCreate
from ...models.http_validation_error import HTTPValidationError
from ...models.integration_db import IntegrationDB
from ...types import Response


def _get_kwargs(*, body: DatabricksIntegrationCreate) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.PUT,
        "return_raw_response": True,
        "path": "/integrations/databricks/unity-catalog/sql",
    }
...
def sync(*, client: ApiClient, body: DatabricksIntegrationCreate) -> Optional[HTTPValidationError | IntegrationDB]:
    """Create or update Databricks integration (legacy)
