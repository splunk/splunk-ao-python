...
def _get_kwargs(name: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/integrations/custom/{name}/definition".format(name=name),
    }
...
def sync(name: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get definition of a named custom integration
...
async def asyncio_detailed(name: str, *, client: ApiClient) -> Response[HTTPValidationError]:
    """Get definition of a named custom integration
...
async def asyncio(name: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get definition of a named custom integration
