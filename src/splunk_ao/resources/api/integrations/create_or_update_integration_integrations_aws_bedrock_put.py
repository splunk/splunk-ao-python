...
from ... import errors
from ...models.base_aws_integration_create import BaseAwsIntegrationCreate
from ...models.http_validation_error import HTTPValidationError
from ...models.integration_db import IntegrationDB
from ...types import Response


def _get_kwargs(*, body: BaseAwsIntegrationCreate) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.PUT,
        "return_raw_response": True,
        "path": "/integrations/aws_bedrock",
    }
...
def sync(*, client: ApiClient, body: BaseAwsIntegrationCreate) -> Optional[Union[HTTPValidationError, IntegrationDB]]:
    """Create or update AWS Bedrock integration
