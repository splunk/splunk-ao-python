...
def _get_kwargs(dataset_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/datasets/{dataset_id}/variable_preview".format(dataset_id=dataset_id),
    }
...
def sync(dataset_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get Dataset Variable Preview
...
async def asyncio_detailed(dataset_id: str, *, client: ApiClient) -> Response[HTTPValidationError]:
    """Get Dataset Variable Preview
...
async def asyncio(dataset_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get Dataset Variable Preview
