...
def _get_kwargs(project_id: str, experiment_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/experiments/{experiment_id}".format(
...
def sync(project_id: str, experiment_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Delete Experiment
...
async def asyncio(project_id: str, experiment_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Delete Experiment
