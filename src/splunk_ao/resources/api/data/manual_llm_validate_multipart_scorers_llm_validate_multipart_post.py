...
from ... import errors
from ...models.body_manual_llm_validate_multipart_scorers_llm_validate_multipart_post import (
...
def _get_kwargs(*, body: BodyManualLlmValidateMultipartScorersLlmValidateMultipartPost) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/scorers/llm/validate/multipart",
    }
