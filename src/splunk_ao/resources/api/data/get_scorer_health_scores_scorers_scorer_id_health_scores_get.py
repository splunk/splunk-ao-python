...
from ...models.scorer_health_scores_response import ScorerHealthScoresResponse
from ...types import UNSET, Response


def _get_kwargs(scorer_id: str, *, dataset_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/scorers/{scorer_id}/health-scores".format(scorer_id=scorer_id),
        "params": params,
    }
