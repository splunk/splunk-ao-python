...
from ... import errors
from ...models.compute_health_score_request import ComputeHealthScoreRequest
from ...models.health_score_result import HealthScoreResult
from ...models.http_validation_error import HTTPValidationError
from ...types import Response


def _get_kwargs(project_id: str, run_id: str, *, body: ComputeHealthScoreRequest) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/projects/{project_id}/metrics-testing/{run_id}/health-score".format(
