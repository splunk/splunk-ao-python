...
from ... import errors
from ...models.annotation_template_reorder import AnnotationTemplateReorder
from ...models.http_validation_error import HTTPValidationError
from ...types import Response


def _get_kwargs(queue_id: str, *, body: AnnotationTemplateReorder) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/annotation_queues/{queue_id}/templates/reorder".format(queue_id=queue_id),
    }
...
def sync_detailed(
    ...
    Args:
        queue_id (str):
        body (AnnotationTemplateReorder): Request to re-order the annotation templates of a
            project.

            - Expects a list of strings where each string is the ID of a template in the project in
            the order
