...
from ...models.annotation_template_update import AnnotationTemplateUpdate
from ...models.http_validation_error import HTTPValidationError
from ...types import Response


def _get_kwargs(queue_id: str, template_id: str, *, body: AnnotationTemplateUpdate) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.PATCH,
        "return_raw_response": True,
        "path": "/annotation_queues/{queue_id}/templates/{template_id}".format(
            queue_id=queue_id, template_id=template_id
        ),
    }
