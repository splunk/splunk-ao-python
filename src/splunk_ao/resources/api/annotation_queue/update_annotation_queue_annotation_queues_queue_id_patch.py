...
from ...models.update_annotation_queue_request import UpdateAnnotationQueueRequest
from ...types import Response


def _get_kwargs(queue_id: str, *, body: UpdateAnnotationQueueRequest) -> dict[str, Any]:
