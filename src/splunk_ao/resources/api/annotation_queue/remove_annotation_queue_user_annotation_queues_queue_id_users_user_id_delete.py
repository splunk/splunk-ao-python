...
def sync_detailed(queue_id: str, user_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
...
def sync(queue_id: str, user_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Remove Annotation Queue User
...
async def asyncio_detailed(queue_id: str, user_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
    """Remove Annotation Queue User
...
async def asyncio(queue_id: str, user_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Remove Annotation Queue User
