...
from ... import errors
from ...models.annotation_queue_count_request import AnnotationQueueCountRequest
from ...models.http_validation_error import HTTPValidationError
from ...models.log_records_query_count_response import LogRecordsQueryCountResponse
from ...types import Response


def _get_kwargs(queue_id: str, *, body: AnnotationQueueCountRequest) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/annotation_queues/{queue_id}/records/count".format(queue_id=queue_id),
    }
...
def sync_detailed(
    queue_id: str, *, client: ApiClient, body: AnnotationQueueCountRequest
) -> Response[Union[HTTPValidationError, LogRecordsQueryCountResponse]]:
