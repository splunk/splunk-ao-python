...
T = TypeVar("T", bound="TreeChoiceRating")


@_attrs_define
class TreeChoiceRating:
    """
    Attributes:
        value (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tree_choice_rating = cls(value=value, annotation_type=annotation_type)

        tree_choice_rating.additional_properties = d
        return tree_choice_rating
