...
T = TypeVar("T", bound="ExtendedLlmSpanRecordAnnotationAggregates")
...
class ExtendedLlmSpanRecordAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_llm_span_record_annotation_aggregates = cls()
        ...
        extended_llm_span_record_annotation_aggregates.additional_properties = additional_properties
        return extended_llm_span_record_annotation_aggregates
