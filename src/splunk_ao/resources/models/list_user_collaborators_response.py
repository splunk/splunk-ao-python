...
T = TypeVar("T", bound="ListUserCollaboratorsResponse")


@_attrs_define
class ListUserCollaboratorsResponse:
    """
    Attributes
    ----------
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for collaborators_item_data in _collaborators:
            collaborators_item = UserCollaborator.from_dict(collaborators_item_data)
        ...
        list_user_collaborators_response = cls(
        ...
        list_user_collaborators_response.additional_properties = d
        return list_user_collaborators_response
