...
T = TypeVar("T", bound="ExtendedWorkflowSpanRecordAnnotationAggregates")


@_attrs_define
class ExtendedWorkflowSpanRecordAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_workflow_span_record_annotation_aggregates = cls()
        ...
        extended_workflow_span_record_annotation_aggregates.additional_properties = additional_properties
        return extended_workflow_span_record_annotation_aggregates
