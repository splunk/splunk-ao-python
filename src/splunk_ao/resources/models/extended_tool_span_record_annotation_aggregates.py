...
T = TypeVar("T", bound="ExtendedToolSpanRecordAnnotationAggregates")


@_attrs_define
class ExtendedToolSpanRecordAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_tool_span_record_annotation_aggregates = cls()
        ...
        extended_tool_span_record_annotation_aggregates.additional_properties = additional_properties
        return extended_tool_span_record_annotation_aggregates
