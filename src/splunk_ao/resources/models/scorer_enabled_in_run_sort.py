...
T = TypeVar("T", bound="ScorerEnabledInRunSort")
...
class ScorerEnabledInRunSort:
    ...
    value: str
    name: Union[Literal["enabled_in_run"], Unset] = "enabled_in_run"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        name = cast(Union[Literal["enabled_in_run"], Unset], d.pop("name", UNSET))
        if name != "enabled_in_run" and not isinstance(name, Unset):
            raise ValueError(f"name must match const 'enabled_in_run', got '{name}'")
        ...
        scorer_enabled_in_run_sort = cls(value=value, name=name, ascending=ascending, sort_type=sort_type)

        scorer_enabled_in_run_sort.additional_properties = d
        return scorer_enabled_in_run_sort
