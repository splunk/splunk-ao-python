...
if TYPE_CHECKING:
    ...
    from ..models.partial_extended_control_span_record_feedback_rating_info import (
        PartialExtendedControlSpanRecordFeedbackRatingInfo,
    )
    from ..models.partial_extended_control_span_record_files_type_0 import PartialExtendedControlSpanRecordFilesType0
...
T = TypeVar("T", bound="PartialExtendedControlSpanRecord")
...
class PartialExtendedControlSpanRecord:
    ...
    ----------
        ...
        overall_annotation_agreement (Union[Unset, PartialExtendedControlSpanRecordOverallAnnotationAgreement]): Average
    ...
    overall_annotation_agreement: Union[Unset, "PartialExtendedControlSpanRecordOverallAnnotationAgreement"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.control_result import ControlResult
        from ..models.partial_extended_control_span_record_files_type_0 import (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: Unset | PartialExtendedControlSpanRecordUserMetadata
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = PartialExtendedControlSpanRecordUserMetadata.from_dict(_user_metadata)
        ...
        dataset_metadata: Unset | PartialExtendedControlSpanRecordDatasetMetadata
        ...
        feedback_rating_info: Unset | PartialExtendedControlSpanRecordFeedbackRatingInfo
        ...
        annotations: Unset | PartialExtendedControlSpanRecordAnnotations
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = PartialExtendedControlSpanRecordAnnotations.from_dict(_annotations)
        ...
        annotation_aggregates: Unset | PartialExtendedControlSpanRecordAnnotationAggregates
        if isinstance(_annotation_aggregates, Unset):
            annotation_aggregates = UNSET
        else:
            annotation_aggregates = PartialExtendedControlSpanRecordAnnotationAggregates.from_dict(
                _annotation_aggregates
            )

        _annotation_agreement = d.pop("annotation_agreement", UNSET)
        annotation_agreement: Unset | PartialExtendedControlSpanRecordAnnotationAgreement
        ...
        overall_annotation_agreement: Unset | PartialExtendedControlSpanRecordOverallAnnotationAgreement
        ...
        partial_extended_control_span_record = cls(
            type_=type_,
            input_=input_,
        ...
        partial_extended_control_span_record.additional_properties = d
        return partial_extended_control_span_record
