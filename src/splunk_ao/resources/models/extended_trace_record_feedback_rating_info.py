...
T = TypeVar("T", bound="ExtendedTraceRecordFeedbackRatingInfo")
...
class ExtendedTraceRecordFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_trace_record_feedback_rating_info = cls()
        ...
        extended_trace_record_feedback_rating_info.additional_properties = additional_properties
        return extended_trace_record_feedback_rating_info
