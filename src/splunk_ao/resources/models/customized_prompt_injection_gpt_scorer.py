...
class CustomizedPromptInjectionGPTScorer:
    """
    Attributes:
        scorer_name (Union[Literal['_customized_prompt_injection_gpt'], Unset]):  Default:
        ...
        aggregates (Union['CustomizedPromptInjectionGPTScorerAggregatesType0', None, Unset]):
    ...
    scorer_name: Union[Literal["_customized_prompt_injection_gpt"], Unset] = "_customized_prompt_injection_gpt"
    ...
    aggregates: Union["CustomizedPromptInjectionGPTScorerAggregatesType0", None, Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Union[Literal["_customized_prompt_injection_gpt"], Unset], d.pop("scorer_name", UNSET))
        ...
        def _parse_aggregates(data: object) -> Union["CustomizedPromptInjectionGPTScorerAggregatesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["CustomizedPromptInjectionGPTScorerAggregatesType0", None, Unset], data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> Union["CustomizedPromptInjectionGPTScorerExtraType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["CustomizedPromptInjectionGPTScorerExtraType0", None, Unset], data)
        ...
        chainpoll_template: Union[Unset, PromptInjectionTemplate]
