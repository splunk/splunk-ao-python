...
T = TypeVar("T", bound="AnnotationQueueCreatedAtFilter")


@_attrs_define
class AnnotationQueueCreatedAtFilter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        annotation_queue_created_at_filter = cls(operator=operator, value=value, name=name)

        annotation_queue_created_at_filter.additional_properties = d
