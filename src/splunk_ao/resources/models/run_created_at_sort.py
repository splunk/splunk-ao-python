...
T = TypeVar("T", bound="RunCreatedAtSort")


@_attrs_define
class RunCreatedAtSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        run_created_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        run_created_at_sort.additional_properties = d
        return run_created_at_sort
