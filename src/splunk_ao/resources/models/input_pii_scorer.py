...
T = TypeVar("T", bound="InputPIIScorer")
...
class InputPIIScorer:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        name = cast(Literal["input_pii"] | Unset, d.pop("name", UNSET))
        ...
        input_pii_scorer = cls(name=name, filters=filters)
