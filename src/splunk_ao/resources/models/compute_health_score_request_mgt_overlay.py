...
T = TypeVar("T", bound="ComputeHealthScoreRequestMgtOverlay")
...
class ComputeHealthScoreRequestMgtOverlay:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        compute_health_score_request_mgt_overlay = cls()
        ...
        compute_health_score_request_mgt_overlay.additional_properties = additional_properties
        return compute_health_score_request_mgt_overlay
