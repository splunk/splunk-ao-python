...
T = TypeVar("T", bound="UncertaintyScorer")
...
class UncertaintyScorer:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        name = cast(Literal["uncertainty"] | Unset, d.pop("name", UNSET))
