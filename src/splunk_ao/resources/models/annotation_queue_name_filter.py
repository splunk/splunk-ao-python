...
from ..models.annotation_queue_name_filter_operator import AnnotationQueueNameFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="AnnotationQueueNameFilter")


@_attrs_define
class AnnotationQueueNameFilter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operator = AnnotationQueueNameFilterOperator(d.pop("operator"))
        ...
        name = cast(Literal["name"] | Unset, d.pop("name", UNSET))
        ...
        annotation_queue_name_filter = cls(operator=operator, value=value, name=name, case_sensitive=case_sensitive)

        annotation_queue_name_filter.additional_properties = d
