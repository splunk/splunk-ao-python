...
from ..models.annotation_queue_num_annotators_filter_operator import AnnotationQueueNumAnnotatorsFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="AnnotationQueueNumAnnotatorsFilter")


@_attrs_define
class AnnotationQueueNumAnnotatorsFilter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        annotation_queue_num_annotators_filter = cls(operator=operator, value=value, name=name)

        annotation_queue_num_annotators_filter.additional_properties = d
