...
class CustomizedToolErrorRateGPTScorer:
    ...
    Attributes:
        ...
        aggregates (Union['CustomizedToolErrorRateGPTScorerAggregatesType0', None, Unset]):
        ...
        class_name_to_vocab_ix (Union['CustomizedToolErrorRateGPTScorerClassNameToVocabIxType0',
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_aggregates(data: object) -> Union["CustomizedToolErrorRateGPTScorerAggregatesType0", None, Unset]:
            ...
            try:
                ...
                pass
            return cast(Union["CustomizedToolErrorRateGPTScorerAggregatesType0", None, Unset], data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> Union["CustomizedToolErrorRateGPTScorerExtraType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
