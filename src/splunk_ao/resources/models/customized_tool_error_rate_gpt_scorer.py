...
if TYPE_CHECKING:
    ...
    from ..models.customized_tool_error_rate_gpt_scorer_class_name_to_vocab_ix_type_0 import (
        CustomizedToolErrorRateGPTScorerClassNameToVocabIxType0,
    )
    from ..models.customized_tool_error_rate_gpt_scorer_class_name_to_vocab_ix_type_1 import (
...
T = TypeVar("T", bound="CustomizedToolErrorRateGPTScorer")


@_attrs_define
class CustomizedToolErrorRateGPTScorer:
    """
    Attributes:
        scorer_name (Literal['_customized_tool_error_rate'] | Unset):  Default: '_customized_tool_error_rate'.
        ...
        aggregates (CustomizedToolErrorRateGPTScorerAggregatesType0 | None | Unset):
        aggregate_keys (list[str] | Unset):
        extra (CustomizedToolErrorRateGPTScorerExtraType0 | None | Unset):
        ...
        chainpoll_template (ToolErrorRateTemplate | Unset): Template for the tool error rate metric,
        ...
        class_name_to_vocab_ix (CustomizedToolErrorRateGPTScorerClassNameToVocabIxType0 |
    ...
    aggregates: CustomizedToolErrorRateGPTScorerAggregatesType0 | None | Unset = UNSET
    aggregate_keys: list[str] | Unset = UNSET
    extra: CustomizedToolErrorRateGPTScorerExtraType0 | None | Unset = UNSET
    ...
    chainpoll_template: ToolErrorRateTemplate | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.class_name_to_vocab_ix, CustomizedToolErrorRateGPTScorerClassNameToVocabIxType0):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        elif isinstance(self.class_name_to_vocab_ix, CustomizedToolErrorRateGPTScorerClassNameToVocabIxType1):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_aggregates(data: object) -> CustomizedToolErrorRateGPTScorerAggregatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                aggregates_type_0 = CustomizedToolErrorRateGPTScorerAggregatesType0.from_dict(data)

                return aggregates_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedToolErrorRateGPTScorerAggregatesType0 | None | Unset, data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> CustomizedToolErrorRateGPTScorerExtraType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_type_0 = CustomizedToolErrorRateGPTScorerExtraType0.from_dict(data)

                return extra_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedToolErrorRateGPTScorerExtraType0 | None | Unset, data)
        ...
        chainpoll_template: ToolErrorRateTemplate | Unset
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                class_name_to_vocab_ix_type_0 = CustomizedToolErrorRateGPTScorerClassNameToVocabIxType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                class_name_to_vocab_ix_type_1 = CustomizedToolErrorRateGPTScorerClassNameToVocabIxType1.from_dict(data)
        ...
        customized_tool_error_rate_gpt_scorer = cls(
        ...
        customized_tool_error_rate_gpt_scorer.additional_properties = d
        return customized_tool_error_rate_gpt_scorer
