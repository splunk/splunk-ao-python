    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_aggregates(data: object) -> Union["CustomizedToolErrorRateGPTScorerAggregatesType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedToolErrorRateGPTScorerAggregatesType0.from_dict(data)
        ...
        def _parse_extra(data: object) -> Union["CustomizedToolErrorRateGPTScorerExtraType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedToolErrorRateGPTScorerExtraType0.from_dict(data)
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedToolErrorRateGPTScorerClassNameToVocabIxType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedToolErrorRateGPTScorerClassNameToVocabIxType1.from_dict(data)
