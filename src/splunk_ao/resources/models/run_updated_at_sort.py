...
T = TypeVar("T", bound="RunUpdatedAtSort")


@_attrs_define
class RunUpdatedAtSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        run_updated_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        run_updated_at_sort.additional_properties = d
        return run_updated_at_sort
