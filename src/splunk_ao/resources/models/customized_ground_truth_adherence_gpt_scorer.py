...
class CustomizedGroundTruthAdherenceGPTScorer:
    """
    Attributes:
        scorer_name (Literal['_customized_ground_truth_adherence'] | Unset):  Default:
        ...
        aggregates (CustomizedGroundTruthAdherenceGPTScorerAggregatesType0 | None | Unset):
        aggregate_keys (list[str] | Unset):
        extra (CustomizedGroundTruthAdherenceGPTScorerExtraType0 | None | Unset):
        ...
        chainpoll_template (GroundTruthAdherenceTemplate | Unset):
        ...
        class_name_to_vocab_ix (CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIxType0 |
            CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIxType1 | None | Unset):
    """

    scorer_name: Literal["_customized_ground_truth_adherence"] | Unset = "_customized_ground_truth_adherence"
    ...
    aggregates: CustomizedGroundTruthAdherenceGPTScorerAggregatesType0 | None | Unset = UNSET
    aggregate_keys: list[str] | Unset = UNSET
    extra: CustomizedGroundTruthAdherenceGPTScorerExtraType0 | None | Unset = UNSET
    ...
    chainpoll_template: GroundTruthAdherenceTemplate | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.class_name_to_vocab_ix, CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIxType0):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        elif isinstance(self.class_name_to_vocab_ix, CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIxType1):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Literal["_customized_ground_truth_adherence"] | Unset, d.pop("scorer_name", UNSET))
        ...
        def _parse_aggregates(data: object) -> CustomizedGroundTruthAdherenceGPTScorerAggregatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                aggregates_type_0 = CustomizedGroundTruthAdherenceGPTScorerAggregatesType0.from_dict(data)

                return aggregates_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedGroundTruthAdherenceGPTScorerAggregatesType0 | None | Unset, data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> CustomizedGroundTruthAdherenceGPTScorerExtraType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_type_0 = CustomizedGroundTruthAdherenceGPTScorerExtraType0.from_dict(data)

                return extra_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedGroundTruthAdherenceGPTScorerExtraType0 | None | Unset, data)
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                ...
                class_name_to_vocab_ix_type_0 = (
                    CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIxType0.from_dict(data)
                )
            ...
            try:
                ...
                class_name_to_vocab_ix_type_1 = (
                    CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIxType1.from_dict(data)
                )
