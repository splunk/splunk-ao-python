...
class InputToxicityScorer:
    ...
    Attributes:
        ...
        filters (list[MetadataFilter | ModalityFilter | NodeNameFilter] | None | Unset): List of filters to apply to the
            scorer.
        type_ (InputToxicityScorerType | Unset):  Default: InputToxicityScorerType.LUNA.
    ...
    type_: InputToxicityScorerType | Unset = InputToxicityScorerType.LUNA
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: InputToxicityScorerType | Unset
