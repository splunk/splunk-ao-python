...
class PartialExtendedWorkflowSpanRecord:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: Union[Unset, PartialExtendedWorkflowSpanRecordUserMetadata]
        ...
        dataset_metadata: Union[Unset, PartialExtendedWorkflowSpanRecordDatasetMetadata]
        ...
        annotation_agreement: Union[Unset, PartialExtendedWorkflowSpanRecordAnnotationAgreement]
