...
if TYPE_CHECKING:
    ...
    from ..models.partial_extended_workflow_span_record_annotation_agreement import (
...
@_attrs_define
class PartialExtendedWorkflowSpanRecord:
    """
    Attributes:
        ...
        user_metadata (PartialExtendedWorkflowSpanRecordUserMetadata | Unset): Metadata associated with this trace or
            span.
        ...
        dataset_metadata (PartialExtendedWorkflowSpanRecordDatasetMetadata | Unset): Metadata from the dataset
        ...
        feedback_rating_info (PartialExtendedWorkflowSpanRecordFeedbackRatingInfo | Unset): Feedback information related
            to the record
        annotations (PartialExtendedWorkflowSpanRecordAnnotations | Unset): Annotations keyed by template ID and
            annotator ID
        ...
        annotation_aggregates (PartialExtendedWorkflowSpanRecordAnnotationAggregates | Unset): Annotation aggregate
    ...
    user_metadata: PartialExtendedWorkflowSpanRecordUserMetadata | Unset = UNSET
    ...
    dataset_metadata: PartialExtendedWorkflowSpanRecordDatasetMetadata | Unset = UNSET
    ...
    feedback_rating_info: PartialExtendedWorkflowSpanRecordFeedbackRatingInfo | Unset = UNSET
    annotations: PartialExtendedWorkflowSpanRecordAnnotations | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metric_info, Unset):
            metric_info = UNSET
        elif isinstance(self.metric_info, PartialExtendedWorkflowSpanRecordMetricInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: PartialExtendedWorkflowSpanRecordUserMetadata | Unset
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = PartialExtendedWorkflowSpanRecordUserMetadata.from_dict(_user_metadata)
        ...
        dataset_metadata: PartialExtendedWorkflowSpanRecordDatasetMetadata | Unset
        if isinstance(_dataset_metadata, Unset):
            dataset_metadata = UNSET
        else:
            dataset_metadata = PartialExtendedWorkflowSpanRecordDatasetMetadata.from_dict(_dataset_metadata)
        ...
        feedback_rating_info: PartialExtendedWorkflowSpanRecordFeedbackRatingInfo | Unset
        ...
        annotations: PartialExtendedWorkflowSpanRecordAnnotations | Unset
        ...
        annotation_aggregates: PartialExtendedWorkflowSpanRecordAnnotationAggregates | Unset
        ...
        annotation_agreement: PartialExtendedWorkflowSpanRecordAnnotationAgreement | Unset
        ...
        def _parse_metric_info(data: object) -> None | PartialExtendedWorkflowSpanRecordMetricInfoType0 | Unset:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metric_info_type_0 = PartialExtendedWorkflowSpanRecordMetricInfoType0.from_dict(data)

                return metric_info_type_0
            except:  # noqa: E722
                pass
            return cast(None | PartialExtendedWorkflowSpanRecordMetricInfoType0 | Unset, data)

        metric_info = _parse_metric_info(d.pop("metric_info", UNSET))

        def _parse_files(data: object) -> None | PartialExtendedWorkflowSpanRecordFilesType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                files_type_0 = PartialExtendedWorkflowSpanRecordFilesType0.from_dict(data)

                return files_type_0
            except:  # noqa: E722
                pass
            return cast(None | PartialExtendedWorkflowSpanRecordFilesType0 | Unset, data)
        ...
        partial_extended_workflow_span_record = cls(
            type_=type_,
            input_=input_,
        ...
        partial_extended_workflow_span_record.additional_properties = d
        return partial_extended_workflow_span_record
