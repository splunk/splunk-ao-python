...
T = TypeVar("T", bound="ExtendedSessionRecordMetricInfoType0")


@_attrs_define
class ExtendedSessionRecordMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_session_record_metric_info_type_0 = cls()
        ...
        extended_session_record_metric_info_type_0.additional_properties = additional_properties
        return extended_session_record_metric_info_type_0
