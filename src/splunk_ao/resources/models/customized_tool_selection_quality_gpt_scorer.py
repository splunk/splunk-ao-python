    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_aggregates(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedToolSelectionQualityGPTScorerAggregatesType0.from_dict(data)
        ...
        def _parse_extra(data: object) -> Union["CustomizedToolSelectionQualityGPTScorerExtraType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedToolSelectionQualityGPTScorerExtraType0.from_dict(data)
        ...
        chainpoll_template: Unset | ToolSelectionQualityTemplate
