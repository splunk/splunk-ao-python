...
T = TypeVar("T", bound="ExtendedSessionRecordFeedbackRatingInfo")


@_attrs_define
class ExtendedSessionRecordFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_session_record_feedback_rating_info = cls()
        ...
        extended_session_record_feedback_rating_info.additional_properties = additional_properties
        return extended_session_record_feedback_rating_info
