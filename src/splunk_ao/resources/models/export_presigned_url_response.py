...
@_attrs_define
class ExportPresignedUrlResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_presigned_url_response = cls(
            url=url, url_expires_at=url_expires_at, file_name=file_name, content_type=content_type
        )

        export_presigned_url_response.additional_properties = d
        return export_presigned_url_response
