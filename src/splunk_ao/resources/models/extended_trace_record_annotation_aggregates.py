...
T = TypeVar("T", bound="ExtendedTraceRecordAnnotationAggregates")


@_attrs_define
class ExtendedTraceRecordAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_trace_record_annotation_aggregates = cls()
        ...
        extended_trace_record_annotation_aggregates.additional_properties = additional_properties
        return extended_trace_record_annotation_aggregates
