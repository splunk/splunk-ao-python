...
T = TypeVar("T", bound="DatasetRowValuesItemType3")
...
class DatasetRowValuesItemType3:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        dataset_row_values_item_type_3 = cls()
        ...
        dataset_row_values_item_type_3.additional_properties = additional_properties
        return dataset_row_values_item_type_3
