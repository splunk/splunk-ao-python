...
T = TypeVar("T", bound="CustomizedFactualityGPTScorer")
...
class CustomizedFactualityGPTScorer:
    """
    Attributes:
        scorer_name (Literal['_customized_factuality'] | Unset):  Default: '_customized_factuality'.
        model_alias (str | Unset):  Default: 'gpt-4.1-mini'.
        num_judges (int | Unset):  Default: 3.
        name (Literal['correctness'] | Unset):  Default: 'correctness'.
        scores (list[Any] | None | Unset):
        indices (list[int] | None | Unset):
        aggregates (CustomizedFactualityGPTScorerAggregatesType0 | None | Unset):
        aggregate_keys (list[str] | Unset):
        extra (CustomizedFactualityGPTScorerExtraType0 | None | Unset):
        ...
        chainpoll_template (FactualityTemplate | Unset):
    ...
    scorer_name: Literal["_customized_factuality"] | Unset = "_customized_factuality"
    model_alias: str | Unset = "gpt-4.1-mini"
    num_judges: int | Unset = 3
    name: Literal["correctness"] | Unset = "correctness"
    scores: list[Any] | None | Unset = UNSET
    indices: list[int] | None | Unset = UNSET
    aggregates: CustomizedFactualityGPTScorerAggregatesType0 | None | Unset = UNSET
    aggregate_keys: list[str] | Unset = UNSET
    extra: CustomizedFactualityGPTScorerExtraType0 | None | Unset = UNSET
    ...
    chainpoll_template: FactualityTemplate | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.aggregates, Unset):
            aggregates = UNSET
        elif isinstance(self.aggregates, CustomizedFactualityGPTScorerAggregatesType0):
        ...
        if isinstance(self.extra, Unset):
            extra = UNSET
        elif isinstance(self.extra, CustomizedFactualityGPTScorerExtraType0):
        ...
        elif isinstance(self.class_name_to_vocab_ix, CustomizedFactualityGPTScorerClassNameToVocabIxType0):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        elif isinstance(self.class_name_to_vocab_ix, CustomizedFactualityGPTScorerClassNameToVocabIxType1):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Literal["_customized_factuality"] | Unset, d.pop("scorer_name", UNSET))
        if scorer_name != "_customized_factuality" and not isinstance(scorer_name, Unset):
            raise ValueError(f"scorer_name must match const '_customized_factuality', got '{scorer_name}'")

        model_alias = d.pop("model_alias", UNSET)

        num_judges = d.pop("num_judges", UNSET)

        name = cast(Literal["correctness"] | Unset, d.pop("name", UNSET))
        if name != "correctness" and not isinstance(name, Unset):
            raise ValueError(f"name must match const 'correctness', got '{name}'")
        ...
        def _parse_aggregates(data: object) -> CustomizedFactualityGPTScorerAggregatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                aggregates_type_0 = CustomizedFactualityGPTScorerAggregatesType0.from_dict(data)

                return aggregates_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedFactualityGPTScorerAggregatesType0 | None | Unset, data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> CustomizedFactualityGPTScorerExtraType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_type_0 = CustomizedFactualityGPTScorerExtraType0.from_dict(data)

                return extra_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedFactualityGPTScorerExtraType0 | None | Unset, data)
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                class_name_to_vocab_ix_type_0 = CustomizedFactualityGPTScorerClassNameToVocabIxType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                class_name_to_vocab_ix_type_1 = CustomizedFactualityGPTScorerClassNameToVocabIxType1.from_dict(data)
        ...
        customized_factuality_gpt_scorer.additional_properties = d
        return customized_factuality_gpt_scorer
