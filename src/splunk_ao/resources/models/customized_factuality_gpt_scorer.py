...
class CustomizedFactualityGPTScorer:
    ...
    function_explanation_param_name: Unset | str = "explanation"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_aggregates(data: object) -> Union["CustomizedFactualityGPTScorerAggregatesType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedFactualityGPTScorerAggregatesType0.from_dict(data)
        ...
        def _parse_extra(data: object) -> Union["CustomizedFactualityGPTScorerExtraType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return CustomizedFactualityGPTScorerExtraType0.from_dict(data)
        ...
        chainpoll_template: Unset | FactualityTemplate
