...
class CustomizedFactualityGPTScorer:
    """
    Attributes:
        scorer_name (Union[Literal['_customized_factuality'], Unset]):  Default: '_customized_factuality'.
    ...
    scorer_name: Union[Literal["_customized_factuality"], Unset] = "_customized_factuality"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Union[Literal["_customized_factuality"], Unset], d.pop("scorer_name", UNSET))
        ...
        name = cast(Union[Literal["correctness"], Unset], d.pop("name", UNSET))
        ...
        def _parse_aggregates(data: object) -> Union["CustomizedFactualityGPTScorerAggregatesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["CustomizedFactualityGPTScorerAggregatesType0", None, Unset], data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> Union["CustomizedFactualityGPTScorerExtraType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
