...
if TYPE_CHECKING:
    from ..models.customized_sexist_gpt_scorer_aggregates_type_0 import CustomizedSexistGPTScorerAggregatesType0
    from ..models.customized_sexist_gpt_scorer_class_name_to_vocab_ix_type_0 import (
        CustomizedSexistGPTScorerClassNameToVocabIxType0,
    )
    from ..models.customized_sexist_gpt_scorer_class_name_to_vocab_ix_type_1 import (
        CustomizedSexistGPTScorerClassNameToVocabIxType1,
    )
    from ..models.customized_sexist_gpt_scorer_extra_type_0 import CustomizedSexistGPTScorerExtraType0
...
T = TypeVar("T", bound="CustomizedSexistGPTScorer")
...
class CustomizedSexistGPTScorer:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.class_name_to_vocab_ix, CustomizedSexistGPTScorerClassNameToVocabIxType1):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_aggregates(data: object) -> CustomizedSexistGPTScorerAggregatesType0 | None | Unset:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                aggregates_type_0 = CustomizedSexistGPTScorerAggregatesType0.from_dict(data)
        ...
        def _parse_extra(data: object) -> CustomizedSexistGPTScorerExtraType0 | None | Unset:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_type_0 = CustomizedSexistGPTScorerExtraType0.from_dict(data)
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                class_name_to_vocab_ix_type_0 = CustomizedSexistGPTScorerClassNameToVocabIxType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                class_name_to_vocab_ix_type_1 = CustomizedSexistGPTScorerClassNameToVocabIxType1.from_dict(data)
        ...
        return customized_sexist_gpt_scorer
