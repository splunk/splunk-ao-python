...
T = TypeVar("T", bound="OutputToneScorer")
...
class OutputToneScorer:
    """
    Attributes:
        name (Literal['output_tone'] | Unset):  Default: 'output_tone'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_tone_scorer = cls(name=name, filters=filters)

        output_tone_scorer.additional_properties = d
        return output_tone_scorer
