...
class AgenticWorkflowSuccessScorer:
    ...
    Attributes:
        ...
        filters (list[MetadataFilter | ModalityFilter | NodeNameFilter] | None | Unset): List of filters to apply to the
            scorer.
        type_ (AgenticWorkflowSuccessScorerType | Unset):  Default: AgenticWorkflowSuccessScorerType.PLUS.
    ...
    type_: AgenticWorkflowSuccessScorerType | Unset = AgenticWorkflowSuccessScorerType.PLUS
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: AgenticWorkflowSuccessScorerType | Unset
