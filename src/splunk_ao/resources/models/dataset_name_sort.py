...
T = TypeVar("T", bound="DatasetNameSort")
...
class DatasetNameSort:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_name_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        dataset_name_sort.additional_properties = d
        return dataset_name_sort
