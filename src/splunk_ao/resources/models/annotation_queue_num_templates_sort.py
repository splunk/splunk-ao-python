...
T = TypeVar("T", bound="AnnotationQueueNumTemplatesSort")


@_attrs_define
class AnnotationQueueNumTemplatesSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        annotation_queue_num_templates_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        annotation_queue_num_templates_sort.additional_properties = d
        return annotation_queue_num_templates_sort
