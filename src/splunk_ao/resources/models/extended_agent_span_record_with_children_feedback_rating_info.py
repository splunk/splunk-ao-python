...
T = TypeVar("T", bound="ExtendedAgentSpanRecordWithChildrenFeedbackRatingInfo")
...
class ExtendedAgentSpanRecordWithChildrenFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_agent_span_record_with_children_feedback_rating_info = cls()
        ...
        extended_agent_span_record_with_children_feedback_rating_info.additional_properties = additional_properties
        return extended_agent_span_record_with_children_feedback_rating_info
