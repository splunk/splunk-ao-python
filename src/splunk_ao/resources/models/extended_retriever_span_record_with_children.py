...
class ExtendedRetrieverSpanRecordWithChildren:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: Union[Unset, ExtendedRetrieverSpanRecordWithChildrenUserMetadata]
        ...
        dataset_metadata: Union[Unset, ExtendedRetrieverSpanRecordWithChildrenDatasetMetadata]
        ...
        annotation_aggregates: Union[Unset, ExtendedRetrieverSpanRecordWithChildrenAnnotationAggregates]
        ...
        annotation_agreement: Union[Unset, ExtendedRetrieverSpanRecordWithChildrenAnnotationAgreement]
