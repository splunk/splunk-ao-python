...
class ExtendedRetrieverSpanRecordWithChildren:
    ...
    Attributes:
        ...
        overall_annotation_agreement (ExtendedRetrieverSpanRecordWithChildrenOverallAnnotationAgreement | Unset):
    ...
    overall_annotation_agreement: ExtendedRetrieverSpanRecordWithChildrenOverallAnnotationAgreement | Unset = UNSET
