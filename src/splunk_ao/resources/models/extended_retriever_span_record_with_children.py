...
if TYPE_CHECKING:
    ...
    from ..models.extended_retriever_span_record_with_children_overall_annotation_agreement import (
...
class ExtendedRetrieverSpanRecordWithChildren:
    ...
    ----------
        ...
        user_metadata (Union[Unset, ExtendedRetrieverSpanRecordWithChildrenUserMetadata]): Metadata associated with this
            trace or span.
        ...
        dataset_metadata (Union[Unset, ExtendedRetrieverSpanRecordWithChildrenDatasetMetadata]): Metadata from the
            dataset associated with this trace
        ...
        feedback_rating_info (Union[Unset, ExtendedRetrieverSpanRecordWithChildrenFeedbackRatingInfo]): Feedback
            information related to the record
        annotations (Union[Unset, ExtendedRetrieverSpanRecordWithChildrenAnnotations]): Annotations keyed by template ID
            and annotator ID
        ...
        annotation_aggregates (Union[Unset, ExtendedRetrieverSpanRecordWithChildrenAnnotationAggregates]): Annotation
            aggregate information keyed by template ID
        annotation_agreement (Union[Unset, ExtendedRetrieverSpanRecordWithChildrenAnnotationAgreement]): Annotation
        ...
        metric_info (Union['ExtendedRetrieverSpanRecordWithChildrenMetricInfoType0', None, Unset]): Detailed information
            about the metrics associated with this trace or span
        files (Union['ExtendedRetrieverSpanRecordWithChildrenFilesType0', None, Unset]): File metadata keyed by file ID
            for files associated with this record
    ...
    user_metadata: Union[Unset, "ExtendedRetrieverSpanRecordWithChildrenUserMetadata"] = UNSET
    ...
    dataset_metadata: Union[Unset, "ExtendedRetrieverSpanRecordWithChildrenDatasetMetadata"] = UNSET
    ...
    feedback_rating_info: Union[Unset, "ExtendedRetrieverSpanRecordWithChildrenFeedbackRatingInfo"] = UNSET
    annotations: Union[Unset, "ExtendedRetrieverSpanRecordWithChildrenAnnotations"] = UNSET
    file_ids: Unset | list[str] = UNSET
    file_modalities: Unset | list[ContentModality] = UNSET
    annotation_aggregates: Union[Unset, "ExtendedRetrieverSpanRecordWithChildrenAnnotationAggregates"] = UNSET
    annotation_agreement: Union[Unset, "ExtendedRetrieverSpanRecordWithChildrenAnnotationAgreement"] = UNSET
    overall_annotation_agreement: Union[Unset, "ExtendedRetrieverSpanRecordWithChildrenOverallAnnotationAgreement"] = (
        UNSET
    )
    annotation_queue_ids: Unset | list[str] = UNSET
    metric_info: Union["ExtendedRetrieverSpanRecordWithChildrenMetricInfoType0", None, Unset] = UNSET
    files: Union["ExtendedRetrieverSpanRecordWithChildrenFilesType0", None, Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: Unset | ExtendedRetrieverSpanRecordWithChildrenUserMetadata
        ...
        dataset_metadata: Unset | ExtendedRetrieverSpanRecordWithChildrenDatasetMetadata
        ...
        feedback_rating_info: Unset | ExtendedRetrieverSpanRecordWithChildrenFeedbackRatingInfo
        ...
        annotations: Unset | ExtendedRetrieverSpanRecordWithChildrenAnnotations
        ...
        annotation_aggregates: Unset | ExtendedRetrieverSpanRecordWithChildrenAnnotationAggregates
        ...
        annotation_agreement: Unset | ExtendedRetrieverSpanRecordWithChildrenAnnotationAgreement
        ...
        overall_annotation_agreement: Unset | ExtendedRetrieverSpanRecordWithChildrenOverallAnnotationAgreement
        if isinstance(_overall_annotation_agreement, Unset):
            overall_annotation_agreement = UNSET
        else:
            overall_annotation_agreement = ExtendedRetrieverSpanRecordWithChildrenOverallAnnotationAgreement.from_dict(
        ...
        def _parse_metric_info(
            data: object,
        ) -> Union["ExtendedRetrieverSpanRecordWithChildrenMetricInfoType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return ExtendedRetrieverSpanRecordWithChildrenMetricInfoType0.from_dict(data)

            except:  # noqa: E722
                pass
            return cast(Union["ExtendedRetrieverSpanRecordWithChildrenMetricInfoType0", None, Unset], data)

        metric_info = _parse_metric_info(d.pop("metric_info", UNSET))

        def _parse_files(data: object) -> Union["ExtendedRetrieverSpanRecordWithChildrenFilesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return ExtendedRetrieverSpanRecordWithChildrenFilesType0.from_dict(data)

            except:  # noqa: E722
                pass
            return cast(Union["ExtendedRetrieverSpanRecordWithChildrenFilesType0", None, Unset], data)
