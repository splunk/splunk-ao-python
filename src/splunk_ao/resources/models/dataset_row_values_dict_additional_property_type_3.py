...
T = TypeVar("T", bound="DatasetRowValuesDictAdditionalPropertyType3")


@_attrs_define
class DatasetRowValuesDictAdditionalPropertyType3:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        dataset_row_values_dict_additional_property_type_3 = cls()
        ...
        dataset_row_values_dict_additional_property_type_3.additional_properties = additional_properties
        return dataset_row_values_dict_additional_property_type_3
