...
if TYPE_CHECKING:
    ...
    from ..models.customized_agentic_session_success_gpt_scorer_class_name_to_vocab_ix_type_0 import (
        CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType0,
    )
    from ..models.customized_agentic_session_success_gpt_scorer_class_name_to_vocab_ix_type_1 import (
        CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType1,
    )
    from ..models.customized_agentic_session_success_gpt_scorer_extra_type_0 import (
...
T = TypeVar("T", bound="CustomizedAgenticSessionSuccessGPTScorer")


@_attrs_define
class CustomizedAgenticSessionSuccessGPTScorer:
    """
    Attributes:
        scorer_name (Literal['_customized_agentic_session_success'] | Unset):  Default:
            '_customized_agentic_session_success'.
        model_alias (str | Unset):  Default: 'gpt-4.1'.
        num_judges (int | Unset):  Default: 3.
        name (Literal['agentic_session_success'] | Unset):  Default: 'agentic_session_success'.
        scores (list[Any] | None | Unset):
        indices (list[int] | None | Unset):
        aggregates (CustomizedAgenticSessionSuccessGPTScorerAggregatesType0 | None | Unset):
        aggregate_keys (list[str] | Unset):
        extra (CustomizedAgenticSessionSuccessGPTScorerExtraType0 | None | Unset):
        ...
        chainpoll_template (AgenticSessionSuccessTemplate | Unset): Template for the agentic session success metric,
        ...
        class_name_to_vocab_ix (CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType0 |
            CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType1 | None | Unset):
    """

    scorer_name: Literal["_customized_agentic_session_success"] | Unset = "_customized_agentic_session_success"
    model_alias: str | Unset = "gpt-4.1"
    num_judges: int | Unset = 3
    name: Literal["agentic_session_success"] | Unset = "agentic_session_success"
    scores: list[Any] | None | Unset = UNSET
    indices: list[int] | None | Unset = UNSET
    aggregates: CustomizedAgenticSessionSuccessGPTScorerAggregatesType0 | None | Unset = UNSET
    aggregate_keys: list[str] | Unset = UNSET
    extra: CustomizedAgenticSessionSuccessGPTScorerExtraType0 | None | Unset = UNSET
    ...
    chainpoll_template: AgenticSessionSuccessTemplate | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.aggregates, Unset):
            aggregates = UNSET
        elif isinstance(self.aggregates, CustomizedAgenticSessionSuccessGPTScorerAggregatesType0):
        ...
        if isinstance(self.extra, Unset):
            extra = UNSET
        elif isinstance(self.extra, CustomizedAgenticSessionSuccessGPTScorerExtraType0):
        ...
        elif isinstance(self.class_name_to_vocab_ix, CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType0):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        elif isinstance(self.class_name_to_vocab_ix, CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType1):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Literal["_customized_agentic_session_success"] | Unset, d.pop("scorer_name", UNSET))
        if scorer_name != "_customized_agentic_session_success" and not isinstance(scorer_name, Unset):
            raise ValueError(f"scorer_name must match const '_customized_agentic_session_success', got '{scorer_name}'")

        model_alias = d.pop("model_alias", UNSET)

        num_judges = d.pop("num_judges", UNSET)

        name = cast(Literal["agentic_session_success"] | Unset, d.pop("name", UNSET))
        ...
        def _parse_aggregates(data: object) -> CustomizedAgenticSessionSuccessGPTScorerAggregatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                aggregates_type_0 = CustomizedAgenticSessionSuccessGPTScorerAggregatesType0.from_dict(data)

                return aggregates_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedAgenticSessionSuccessGPTScorerAggregatesType0 | None | Unset, data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> CustomizedAgenticSessionSuccessGPTScorerExtraType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_type_0 = CustomizedAgenticSessionSuccessGPTScorerExtraType0.from_dict(data)

                return extra_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedAgenticSessionSuccessGPTScorerExtraType0 | None | Unset, data)
        ...
        chainpoll_template: AgenticSessionSuccessTemplate | Unset
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                ...
                class_name_to_vocab_ix_type_0 = (
                    CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType0.from_dict(data)
                )
            ...
            try:
                ...
                class_name_to_vocab_ix_type_1 = (
                    CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType1.from_dict(data)
                )
        ...
        customized_agentic_session_success_gpt_scorer = cls(
        ...
        customized_agentic_session_success_gpt_scorer.additional_properties = d
        return customized_agentic_session_success_gpt_scorer
