...
class CustomizedAgenticSessionSuccessGPTScorer:
    """
    Attributes:
        scorer_name (Union[Literal['_customized_agentic_session_success'], Unset]):  Default:
        ...
        aggregates (Union['CustomizedAgenticSessionSuccessGPTScorerAggregatesType0', None, Unset]):
        ...
        class_name_to_vocab_ix (Union['CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType0',
            'CustomizedAgenticSessionSuccessGPTScorerClassNameToVocabIxType1', None, Unset]):
        scorer_path_name (Union[None, Unset, str]):
    """

    scorer_name: Union[Literal["_customized_agentic_session_success"], Unset] = "_customized_agentic_session_success"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Union[Literal["_customized_agentic_session_success"], Unset], d.pop("scorer_name", UNSET))
        ...
        def _parse_aggregates(
            data: object,
        ) -> Union["CustomizedAgenticSessionSuccessGPTScorerAggregatesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["CustomizedAgenticSessionSuccessGPTScorerAggregatesType0", None, Unset], data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> Union["CustomizedAgenticSessionSuccessGPTScorerExtraType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["CustomizedAgenticSessionSuccessGPTScorerExtraType0", None, Unset], data)
        ...
        chainpoll_template: Union[Unset, AgenticSessionSuccessTemplate]
