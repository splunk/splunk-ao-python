...
T = TypeVar("T", bound="AnnotationQueueUpdatedAtSort")
...
class AnnotationQueueUpdatedAtSort:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        annotation_queue_updated_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        annotation_queue_updated_at_sort.additional_properties = d
        return annotation_queue_updated_at_sort
