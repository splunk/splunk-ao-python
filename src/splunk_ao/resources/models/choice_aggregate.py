...
if TYPE_CHECKING:
    from ..models.choice_aggregate_counts import ChoiceAggregateCounts


T = TypeVar("T", bound="ChoiceAggregate")
...
class ChoiceAggregate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        counts = ChoiceAggregateCounts.from_dict(d.pop("counts"))
        ...
        choice_aggregate = cls(counts=counts, unrated_count=unrated_count, feedback_type=feedback_type)

        choice_aggregate.additional_properties = d
        return choice_aggregate
