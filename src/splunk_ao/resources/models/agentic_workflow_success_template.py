...
class AgenticWorkflowSuccessTemplate:
    ...
    ----------
            ...
            response_schema (Union['AgenticWorkflowSuccessTemplateResponseSchemaType0', None, Unset]): Response schema for
                the output
    """
    ...
    value_field_name: Unset | str = "ai_turn_is_successful"
    explanation_field_name: Unset | str = "explanation"
    template: Unset | str = "Chatbot history:\n```\n{query}\n```\n\nAI's turn:\n```\n{response}\n```"
    metric_few_shot_examples: Unset | list["FewShotExample"] = UNSET
    response_schema: Union["AgenticWorkflowSuccessTemplateResponseSchemaType0", None, Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_response_schema(
            data: object,
        ) -> Union["AgenticWorkflowSuccessTemplateResponseSchemaType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union["AgenticWorkflowSuccessTemplateResponseSchemaType0", None, Unset], data)
