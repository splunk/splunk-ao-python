...
class ExtendedControlSpanRecord:
    ...
    Attributes:
        ...
        user_metadata (ExtendedControlSpanRecordUserMetadata | Unset): Metadata associated with this trace or span.
        ...
        dataset_metadata (ExtendedControlSpanRecordDatasetMetadata | Unset): Metadata from the dataset associated with
            this trace
        ...
        feedback_rating_info (ExtendedControlSpanRecordFeedbackRatingInfo | Unset): Feedback information related to the
            record
        annotations (ExtendedControlSpanRecordAnnotations | Unset): Annotations keyed by template ID and annotator ID
        ...
        files (ExtendedControlSpanRecordFilesType0 | None | Unset): File metadata keyed by file ID for files associated
            with this record
    ...
    user_metadata: ExtendedControlSpanRecordUserMetadata | Unset = UNSET
    ...
    dataset_metadata: ExtendedControlSpanRecordDatasetMetadata | Unset = UNSET
    ...
    feedback_rating_info: ExtendedControlSpanRecordFeedbackRatingInfo | Unset = UNSET
    annotations: ExtendedControlSpanRecordAnnotations | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_metadata: ExtendedControlSpanRecordDatasetMetadata | Unset
        ...
        feedback_rating_info: ExtendedControlSpanRecordFeedbackRatingInfo | Unset
        ...
        annotations: ExtendedControlSpanRecordAnnotations | Unset
        ...
        annotation_aggregates: ExtendedControlSpanRecordAnnotationAggregates | Unset
        ...
        def _parse_files(data: object) -> ExtendedControlSpanRecordFilesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
