...
class RunNameSort:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        run_name_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        run_name_sort.additional_properties = d
        return run_name_sort
