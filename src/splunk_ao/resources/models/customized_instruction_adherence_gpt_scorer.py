...
class CustomizedInstructionAdherenceGPTScorer:
    """
    Attributes:
        scorer_name (Literal['_customized_instruction_adherence'] | Unset):  Default:
            '_customized_instruction_adherence'.
        model_alias (str | Unset):  Default: 'gpt-4.1-mini'.
        num_judges (int | Unset):  Default: 3.
        name (Literal['instruction_adherence'] | Unset):  Default: 'instruction_adherence'.
        scores (list[Any] | None | Unset):
        indices (list[int] | None | Unset):
        aggregates (CustomizedInstructionAdherenceGPTScorerAggregatesType0 | None | Unset):
        aggregate_keys (list[str] | Unset):
        extra (CustomizedInstructionAdherenceGPTScorerExtraType0 | None | Unset):
        ...
        chainpoll_template (InstructionAdherenceTemplate | Unset):
        ...
        class_name_to_vocab_ix (CustomizedInstructionAdherenceGPTScorerClassNameToVocabIxType0 |
    ...
    scorer_name: Literal["_customized_instruction_adherence"] | Unset = "_customized_instruction_adherence"
    model_alias: str | Unset = "gpt-4.1-mini"
    num_judges: int | Unset = 3
    name: Literal["instruction_adherence"] | Unset = "instruction_adherence"
    scores: list[Any] | None | Unset = UNSET
    indices: list[int] | None | Unset = UNSET
    aggregates: CustomizedInstructionAdherenceGPTScorerAggregatesType0 | None | Unset = UNSET
    aggregate_keys: list[str] | Unset = UNSET
    extra: CustomizedInstructionAdherenceGPTScorerExtraType0 | None | Unset = UNSET
    ...
    chainpoll_template: InstructionAdherenceTemplate | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.class_name_to_vocab_ix, CustomizedInstructionAdherenceGPTScorerClassNameToVocabIxType0):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        elif isinstance(self.class_name_to_vocab_ix, CustomizedInstructionAdherenceGPTScorerClassNameToVocabIxType1):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Literal["_customized_instruction_adherence"] | Unset, d.pop("scorer_name", UNSET))
        ...
        name = cast(Literal["instruction_adherence"] | Unset, d.pop("name", UNSET))
        ...
        def _parse_aggregates(data: object) -> CustomizedInstructionAdherenceGPTScorerAggregatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                aggregates_type_0 = CustomizedInstructionAdherenceGPTScorerAggregatesType0.from_dict(data)

                return aggregates_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedInstructionAdherenceGPTScorerAggregatesType0 | None | Unset, data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> CustomizedInstructionAdherenceGPTScorerExtraType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_type_0 = CustomizedInstructionAdherenceGPTScorerExtraType0.from_dict(data)

                return extra_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedInstructionAdherenceGPTScorerExtraType0 | None | Unset, data)
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                ...
                class_name_to_vocab_ix_type_0 = (
                    CustomizedInstructionAdherenceGPTScorerClassNameToVocabIxType0.from_dict(data)
                )
            ...
            try:
                ...
                class_name_to_vocab_ix_type_1 = (
                    CustomizedInstructionAdherenceGPTScorerClassNameToVocabIxType1.from_dict(data)
                )
