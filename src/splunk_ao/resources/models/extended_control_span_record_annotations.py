...
if TYPE_CHECKING:
    from ..models.extended_control_span_record_annotations_additional_property import (
        ExtendedControlSpanRecordAnnotationsAdditionalProperty,
    )


T = TypeVar("T", bound="ExtendedControlSpanRecordAnnotations")
...
class ExtendedControlSpanRecordAnnotations:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_control_span_record_annotations = cls()

        additional_properties = {}
        for prop_name, prop_dict in d.items():
            additional_property = ExtendedControlSpanRecordAnnotationsAdditionalProperty.from_dict(prop_dict)

            additional_properties[prop_name] = additional_property

        extended_control_span_record_annotations.additional_properties = additional_properties
        return extended_control_span_record_annotations
