...
T = TypeVar("T", bound="LogRecordsMetricsResponseBucketedMetrics")


@_attrs_define
class LogRecordsMetricsResponseBucketedMetrics:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_records_metrics_response_bucketed_metrics.additional_properties = additional_properties
        return log_records_metrics_response_bucketed_metrics
