...
T = TypeVar("T", bound="ExtendedTraceRecordWithChildrenFeedbackRatingInfo")


@_attrs_define
class ExtendedTraceRecordWithChildrenFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_trace_record_with_children_feedback_rating_info = cls()
        ...
        extended_trace_record_with_children_feedback_rating_info.additional_properties = additional_properties
        return extended_trace_record_with_children_feedback_rating_info
