...
T = TypeVar("T", bound="ExtendedAgentSpanRecordAnnotationsAdditionalProperty")
...
class ExtendedAgentSpanRecordAnnotationsAdditionalProperty:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_agent_span_record_annotations_additional_property = cls()
        ...
        extended_agent_span_record_annotations_additional_property.additional_properties = additional_properties
        return extended_agent_span_record_annotations_additional_property
