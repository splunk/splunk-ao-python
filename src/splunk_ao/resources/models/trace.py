...
class Trace:
    ...
    Attributes:
        ...
        user_metadata (TraceUserMetadata | Unset): Metadata associated with this trace or span.
        ...
        dataset_metadata (TraceDatasetMetadata | Unset): Metadata from the dataset associated with this trace
    ...
    user_metadata: TraceUserMetadata | Unset = UNSET
    ...
    dataset_metadata: TraceDatasetMetadata | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: TraceUserMetadata | Unset
        ...
        dataset_metadata: TraceDatasetMetadata | Unset
