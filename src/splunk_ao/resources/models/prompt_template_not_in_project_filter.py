...
T = TypeVar("T", bound="PromptTemplateNotInProjectFilter")
...
class PromptTemplateNotInProjectFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        prompt_template_not_in_project_filter = cls(value=value, name=name)

        prompt_template_not_in_project_filter.additional_properties = d
        return prompt_template_not_in_project_filter
