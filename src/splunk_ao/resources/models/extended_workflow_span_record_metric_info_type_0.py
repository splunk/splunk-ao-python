...
T = TypeVar("T", bound="ExtendedWorkflowSpanRecordMetricInfoType0")


@_attrs_define
class ExtendedWorkflowSpanRecordMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_workflow_span_record_metric_info_type_0 = cls()
        ...
        extended_workflow_span_record_metric_info_type_0.additional_properties = additional_properties
        return extended_workflow_span_record_metric_info_type_0
