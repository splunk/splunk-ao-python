...
if TYPE_CHECKING:
    from ..models.agentic_workflow_success_template import AgenticWorkflowSuccessTemplate
    from ..models.customized_agentic_workflow_success_gpt_scorer_aggregates_type_0 import (
        CustomizedAgenticWorkflowSuccessGPTScorerAggregatesType0,
    )
    from ..models.customized_agentic_workflow_success_gpt_scorer_class_name_to_vocab_ix_type_0 import (
        CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxType0,
    )
    from ..models.customized_agentic_workflow_success_gpt_scorer_class_name_to_vocab_ix_type_1 import (
        CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxType1,
    )
    from ..models.customized_agentic_workflow_success_gpt_scorer_extra_type_0 import (
...
T = TypeVar("T", bound="CustomizedAgenticWorkflowSuccessGPTScorer")


@_attrs_define
class CustomizedAgenticWorkflowSuccessGPTScorer:
    """
    Attributes:
        scorer_name (Union[Literal['_customized_agentic_workflow_success'], Unset]):  Default:
            '_customized_agentic_workflow_success'.
        model_alias (Union[Unset, str]):  Default: 'gpt-4.1'.
        num_judges (Union[Unset, int]):  Default: 5.
        name (Union[Literal['agentic_workflow_success'], Unset]):  Default: 'agentic_workflow_success'.
        scores (Union[None, Unset, list[Any]]):
        indices (Union[None, Unset, list[int]]):
        aggregates (Union['CustomizedAgenticWorkflowSuccessGPTScorerAggregatesType0', None, Unset]):
        aggregate_keys (Union[Unset, list[str]]):
        extra (Union['CustomizedAgenticWorkflowSuccessGPTScorerExtraType0', None, Unset]):
        ...
        chainpoll_template (Union[Unset, AgenticWorkflowSuccessTemplate]): Template for the agentic workflow success
            metric,
        ...
        class_name_to_vocab_ix (Union['CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxType0',
            'CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxType1', None, Unset]):
        scorer_path_name (Union[None, Unset, str]):
    """

    scorer_name: Union[Literal["_customized_agentic_workflow_success"], Unset] = "_customized_agentic_workflow_success"
    model_alias: Union[Unset, str] = "gpt-4.1"
    num_judges: Union[Unset, int] = 5
    name: Union[Literal["agentic_workflow_success"], Unset] = "agentic_workflow_success"
    scores: Union[None, Unset, list[Any]] = UNSET
    indices: Union[None, Unset, list[int]] = UNSET
    aggregates: Union["CustomizedAgenticWorkflowSuccessGPTScorerAggregatesType0", None, Unset] = UNSET
    aggregate_keys: Union[Unset, list[str]] = UNSET
    extra: Union["CustomizedAgenticWorkflowSuccessGPTScorerExtraType0", None, Unset] = UNSET
    ...
    chainpoll_template: Union[Unset, "AgenticWorkflowSuccessTemplate"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.aggregates, Unset):
            aggregates = UNSET
        elif isinstance(self.aggregates, CustomizedAgenticWorkflowSuccessGPTScorerAggregatesType0):
        ...
        if isinstance(self.extra, Unset):
            extra = UNSET
        elif isinstance(self.extra, CustomizedAgenticWorkflowSuccessGPTScorerExtraType0):
        ...
        elif isinstance(self.class_name_to_vocab_ix, CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxType0):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        elif isinstance(self.class_name_to_vocab_ix, CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxType1):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Union[Literal["_customized_agentic_workflow_success"], Unset], d.pop("scorer_name", UNSET))
        if scorer_name != "_customized_agentic_workflow_success" and not isinstance(scorer_name, Unset):
            raise ValueError(
                f"scorer_name must match const '_customized_agentic_workflow_success', got '{scorer_name}'"
            )
        ...
        name = cast(Union[Literal["agentic_workflow_success"], Unset], d.pop("name", UNSET))
        if name != "agentic_workflow_success" and not isinstance(name, Unset):
            raise ValueError(f"name must match const 'agentic_workflow_success', got '{name}'")
        ...
        def _parse_aggregates(
            data: object,
        ) -> Union["CustomizedAgenticWorkflowSuccessGPTScorerAggregatesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                aggregates_type_0 = CustomizedAgenticWorkflowSuccessGPTScorerAggregatesType0.from_dict(data)

                return aggregates_type_0
            except:  # noqa: E722
                pass
            return cast(Union["CustomizedAgenticWorkflowSuccessGPTScorerAggregatesType0", None, Unset], data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> Union["CustomizedAgenticWorkflowSuccessGPTScorerExtraType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_type_0 = CustomizedAgenticWorkflowSuccessGPTScorerExtraType0.from_dict(data)

                return extra_type_0
            except:  # noqa: E722
                pass
            return cast(Union["CustomizedAgenticWorkflowSuccessGPTScorerExtraType0", None, Unset], data)
        ...
        chainpoll_template: Union[Unset, AgenticWorkflowSuccessTemplate]
        if isinstance(_chainpoll_template, Unset):
            chainpoll_template = UNSET
        else:
            chainpoll_template = AgenticWorkflowSuccessTemplate.from_dict(_chainpoll_template)
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                ...
                class_name_to_vocab_ix_type_0 = (
                    CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxType0.from_dict(data)
                )
            ...
            try:
                ...
                class_name_to_vocab_ix_type_1 = (
                    CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxType1.from_dict(data)
                )
        ...
        customized_agentic_workflow_success_gpt_scorer = cls(
        ...
        customized_agentic_workflow_success_gpt_scorer.additional_properties = d
        return customized_agentic_workflow_success_gpt_scorer
