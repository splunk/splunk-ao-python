...
class CustomizedAgenticWorkflowSuccessGPTScorer:
    """
    Attributes:
        scorer_name (Literal['_customized_agentic_workflow_success'] | Unset):  Default:
            '_customized_agentic_workflow_success'.
        model_alias (str | Unset):  Default: 'gpt-4.1'.
        num_judges (int | Unset):  Default: 5.
        name (Literal['agentic_workflow_success'] | Unset):  Default: 'agentic_workflow_success'.
        scores (list[Any] | None | Unset):
        indices (list[int] | None | Unset):
        aggregates (CustomizedAgenticWorkflowSuccessGPTScorerAggregatesType0 | None | Unset):
        aggregate_keys (list[str] | Unset):
        extra (CustomizedAgenticWorkflowSuccessGPTScorerExtraType0 | None | Unset):
        ...
        chainpoll_template (AgenticWorkflowSuccessTemplate | Unset): Template for the agentic workflow success metric,
        ...
        class_name_to_vocab_ix (CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxType0 |
            CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxType1 | None | Unset):
    """

    scorer_name: Literal["_customized_agentic_workflow_success"] | Unset = "_customized_agentic_workflow_success"
    model_alias: str | Unset = "gpt-4.1"
    num_judges: int | Unset = 5
    name: Literal["agentic_workflow_success"] | Unset = "agentic_workflow_success"
    scores: list[Any] | None | Unset = UNSET
    indices: list[int] | None | Unset = UNSET
    aggregates: CustomizedAgenticWorkflowSuccessGPTScorerAggregatesType0 | None | Unset = UNSET
    aggregate_keys: list[str] | Unset = UNSET
    extra: CustomizedAgenticWorkflowSuccessGPTScorerExtraType0 | None | Unset = UNSET
    ...
    chainpoll_template: AgenticWorkflowSuccessTemplate | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Literal["_customized_agentic_workflow_success"] | Unset, d.pop("scorer_name", UNSET))
        ...
        name = cast(Literal["agentic_workflow_success"] | Unset, d.pop("name", UNSET))
        ...
        def _parse_aggregates(data: object) -> CustomizedAgenticWorkflowSuccessGPTScorerAggregatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(CustomizedAgenticWorkflowSuccessGPTScorerAggregatesType0 | None | Unset, data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> CustomizedAgenticWorkflowSuccessGPTScorerExtraType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(CustomizedAgenticWorkflowSuccessGPTScorerExtraType0 | None | Unset, data)
        ...
        chainpoll_template: AgenticWorkflowSuccessTemplate | Unset
