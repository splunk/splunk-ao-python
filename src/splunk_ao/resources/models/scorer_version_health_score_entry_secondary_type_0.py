...
T = TypeVar("T", bound="ScorerVersionHealthScoreEntrySecondaryType0")
...
class ScorerVersionHealthScoreEntrySecondaryType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        scorer_version_health_score_entry_secondary_type_0 = cls()
        ...
        scorer_version_health_score_entry_secondary_type_0.additional_properties = additional_properties
        return scorer_version_health_score_entry_secondary_type_0
