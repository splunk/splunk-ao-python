...
class ExtendedRetrieverSpanRecord:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_metadata: Union[Unset, ExtendedRetrieverSpanRecordDatasetMetadata]
        ...
        feedback_rating_info: Union[Unset, ExtendedRetrieverSpanRecordFeedbackRatingInfo]
        ...
        annotation_aggregates: Union[Unset, ExtendedRetrieverSpanRecordAnnotationAggregates]
        ...
        annotation_agreement: Union[Unset, ExtendedRetrieverSpanRecordAnnotationAgreement]
