...
T = TypeVar("T", bound="ExtendedLlmSpanRecordFeedbackRatingInfo")


@_attrs_define
class ExtendedLlmSpanRecordFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_llm_span_record_feedback_rating_info = cls()
        ...
        extended_llm_span_record_feedback_rating_info.additional_properties = additional_properties
        return extended_llm_span_record_feedback_rating_info
