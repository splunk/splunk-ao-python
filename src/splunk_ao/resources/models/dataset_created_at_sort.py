...
T = TypeVar("T", bound="DatasetCreatedAtSort")
...
class DatasetCreatedAtSort:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_created_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        dataset_created_at_sort.additional_properties = d
        return dataset_created_at_sort
