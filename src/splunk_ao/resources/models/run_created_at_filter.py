...
T = TypeVar("T", bound="RunCreatedAtFilter")


@_attrs_define
class RunCreatedAtFilter:
    """
    Attributes
    ----------
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        run_created_at_filter = cls(operator=operator, value=value, name=name)

        run_created_at_filter.additional_properties = d
        return run_created_at_filter
