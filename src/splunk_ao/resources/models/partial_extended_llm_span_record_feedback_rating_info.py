...
T = TypeVar("T", bound="PartialExtendedLlmSpanRecordFeedbackRatingInfo")


@_attrs_define
class PartialExtendedLlmSpanRecordFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        partial_extended_llm_span_record_feedback_rating_info = cls()
        ...
        partial_extended_llm_span_record_feedback_rating_info.additional_properties = additional_properties
        return partial_extended_llm_span_record_feedback_rating_info
