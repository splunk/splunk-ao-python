...
if TYPE_CHECKING:
    from ..models.customized_input_toxicity_gpt_scorer_aggregates_type_0 import (
        CustomizedInputToxicityGPTScorerAggregatesType0,
    )
    from ..models.customized_input_toxicity_gpt_scorer_class_name_to_vocab_ix_type_0 import (
        CustomizedInputToxicityGPTScorerClassNameToVocabIxType0,
    )
    from ..models.customized_input_toxicity_gpt_scorer_class_name_to_vocab_ix_type_1 import (
        CustomizedInputToxicityGPTScorerClassNameToVocabIxType1,
    )
    from ..models.customized_input_toxicity_gpt_scorer_extra_type_0 import CustomizedInputToxicityGPTScorerExtraType0
    from ..models.input_toxicity_template import InputToxicityTemplate
    from ..models.metadata_filter import MetadataFilter
    from ..models.modality_filter import ModalityFilter
    from ..models.node_name_filter import NodeNameFilter


T = TypeVar("T", bound="CustomizedInputToxicityGPTScorer")


@_attrs_define
class CustomizedInputToxicityGPTScorer:
    """
    Attributes:
        scorer_name (Literal['_customized_input_toxicity_gpt'] | Unset):  Default: '_customized_input_toxicity_gpt'.
        model_alias (str | Unset):  Default: 'gpt-4.1-mini'.
        num_judges (int | Unset):  Default: 3.
        name (Literal['input_toxicity'] | Unset):  Default: 'input_toxicity'.
        scores (list[Any] | None | Unset):
        indices (list[int] | None | Unset):
        aggregates (CustomizedInputToxicityGPTScorerAggregatesType0 | None | Unset):
        aggregate_keys (list[str] | Unset):
        extra (CustomizedInputToxicityGPTScorerExtraType0 | None | Unset):
        ...
        chainpoll_template (InputToxicityTemplate | Unset): Template for the toxicity metric,
        ...
        class_name_to_vocab_ix (CustomizedInputToxicityGPTScorerClassNameToVocabIxType0 |
            CustomizedInputToxicityGPTScorerClassNameToVocabIxType1 | None | Unset):
    """

    scorer_name: Literal["_customized_input_toxicity_gpt"] | Unset = "_customized_input_toxicity_gpt"
    model_alias: str | Unset = "gpt-4.1-mini"
    num_judges: int | Unset = 3
    name: Literal["input_toxicity"] | Unset = "input_toxicity"
    scores: list[Any] | None | Unset = UNSET
    indices: list[int] | None | Unset = UNSET
    aggregates: CustomizedInputToxicityGPTScorerAggregatesType0 | None | Unset = UNSET
    aggregate_keys: list[str] | Unset = UNSET
    extra: CustomizedInputToxicityGPTScorerExtraType0 | None | Unset = UNSET
    ...
    chainpoll_template: InputToxicityTemplate | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.customized_input_toxicity_gpt_scorer_extra_type_0 import (
        ...
        if isinstance(self.aggregates, Unset):
            aggregates = UNSET
        elif isinstance(self.aggregates, CustomizedInputToxicityGPTScorerAggregatesType0):
        ...
        if isinstance(self.extra, Unset):
            extra = UNSET
        elif isinstance(self.extra, CustomizedInputToxicityGPTScorerExtraType0):
        ...
        elif isinstance(self.class_name_to_vocab_ix, CustomizedInputToxicityGPTScorerClassNameToVocabIxType0):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        elif isinstance(self.class_name_to_vocab_ix, CustomizedInputToxicityGPTScorerClassNameToVocabIxType1):
            class_name_to_vocab_ix = self.class_name_to_vocab_ix.to_dict()
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Literal["_customized_input_toxicity_gpt"] | Unset, d.pop("scorer_name", UNSET))
        if scorer_name != "_customized_input_toxicity_gpt" and not isinstance(scorer_name, Unset):
            raise ValueError(f"scorer_name must match const '_customized_input_toxicity_gpt', got '{scorer_name}'")

        model_alias = d.pop("model_alias", UNSET)

        num_judges = d.pop("num_judges", UNSET)

        name = cast(Literal["input_toxicity"] | Unset, d.pop("name", UNSET))
        ...
        def _parse_aggregates(data: object) -> CustomizedInputToxicityGPTScorerAggregatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                aggregates_type_0 = CustomizedInputToxicityGPTScorerAggregatesType0.from_dict(data)

                return aggregates_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedInputToxicityGPTScorerAggregatesType0 | None | Unset, data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> CustomizedInputToxicityGPTScorerExtraType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_type_0 = CustomizedInputToxicityGPTScorerExtraType0.from_dict(data)

                return extra_type_0
            except:  # noqa: E722
                pass
            return cast(CustomizedInputToxicityGPTScorerExtraType0 | None | Unset, data)
        ...
        chainpoll_template: InputToxicityTemplate | Unset
        ...
        def _parse_class_name_to_vocab_ix(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                class_name_to_vocab_ix_type_0 = CustomizedInputToxicityGPTScorerClassNameToVocabIxType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                class_name_to_vocab_ix_type_1 = CustomizedInputToxicityGPTScorerClassNameToVocabIxType1.from_dict(data)
        ...
        customized_input_toxicity_gpt_scorer.additional_properties = d
        return customized_input_toxicity_gpt_scorer
