...
class ScorerMultimodalCapabilitiesFilter:
    ...
    values (e.g. ``{"name": "multimodal_capabilities", "operator": "one_of", "value": ["vision", "audio"]}``).
        ...
        Attributes:
            ...
            value (list[str] | str):
            name (Literal['multimodal_capabilities'] | Unset):  Default: 'multimodal_capabilities'.
            case_sensitive (bool | Unset):  Default: True.
    """

    operator: ScorerMultimodalCapabilitiesFilterOperator
    value: list[str] | str
    name: Literal["multimodal_capabilities"] | Unset = "multimodal_capabilities"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        name = cast(Literal["multimodal_capabilities"] | Unset, d.pop("name", UNSET))
