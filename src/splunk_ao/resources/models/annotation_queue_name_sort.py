...
T = TypeVar("T", bound="AnnotationQueueNameSort")


@_attrs_define
class AnnotationQueueNameSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        annotation_queue_name_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        annotation_queue_name_sort.additional_properties = d
        return annotation_queue_name_sort
