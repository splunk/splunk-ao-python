...
class ExtendedSessionRecord:
    ...
    Attributes:
        ...
        user_metadata (ExtendedSessionRecordUserMetadata | Unset): Metadata associated with this trace or span.
        ...
        dataset_metadata (ExtendedSessionRecordDatasetMetadata | Unset): Metadata from the dataset associated with this
            trace
        ...
        feedback_rating_info (ExtendedSessionRecordFeedbackRatingInfo | Unset): Feedback information related to the
            record
        annotations (ExtendedSessionRecordAnnotations | Unset): Annotations keyed by template ID and annotator ID
        ...
        annotation_aggregates (ExtendedSessionRecordAnnotationAggregates | Unset): Annotation aggregate information
            keyed by template ID
        annotation_agreement (ExtendedSessionRecordAnnotationAgreement | Unset): Annotation agreement scores keyed by
            template ID
        overall_annotation_agreement (ExtendedSessionRecordOverallAnnotationAgreement | Unset): Average annotation
            agreement per queue (keyed by queue ID)
        annotation_queue_ids (list[str] | Unset): IDs of annotation queues this record is in
        metric_info (ExtendedSessionRecordMetricInfoType0 | None | Unset): Detailed information about the metrics
            associated with this trace or span
        files (ExtendedSessionRecordFilesType0 | None | Unset): File metadata keyed by file ID for files associated with
            this record
    ...
    user_metadata: ExtendedSessionRecordUserMetadata | Unset = UNSET
    ...
    dataset_metadata: ExtendedSessionRecordDatasetMetadata | Unset = UNSET
    ...
    feedback_rating_info: ExtendedSessionRecordFeedbackRatingInfo | Unset = UNSET
    annotations: ExtendedSessionRecordAnnotations | Unset = UNSET
    file_ids: list[str] | Unset = UNSET
    file_modalities: list[ContentModality] | Unset = UNSET
    annotation_aggregates: ExtendedSessionRecordAnnotationAggregates | Unset = UNSET
    annotation_agreement: ExtendedSessionRecordAnnotationAgreement | Unset = UNSET
    overall_annotation_agreement: ExtendedSessionRecordOverallAnnotationAgreement | Unset = UNSET
    annotation_queue_ids: list[str] | Unset = UNSET
    metric_info: ExtendedSessionRecordMetricInfoType0 | None | Unset = UNSET
    files: ExtendedSessionRecordFilesType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: ExtendedSessionRecordUserMetadata | Unset
        ...
        dataset_metadata: ExtendedSessionRecordDatasetMetadata | Unset
        ...
        feedback_rating_info: ExtendedSessionRecordFeedbackRatingInfo | Unset
        ...
        annotations: ExtendedSessionRecordAnnotations | Unset
        ...
        annotation_aggregates: ExtendedSessionRecordAnnotationAggregates | Unset
        ...
        annotation_agreement: ExtendedSessionRecordAnnotationAgreement | Unset
        ...
        overall_annotation_agreement: ExtendedSessionRecordOverallAnnotationAgreement | Unset
        ...
        def _parse_metric_info(data: object) -> ExtendedSessionRecordMetricInfoType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metric_info_type_0 = ExtendedSessionRecordMetricInfoType0.from_dict(data)

                return metric_info_type_0
            except:  # noqa: E722
                pass
            return cast(ExtendedSessionRecordMetricInfoType0 | None | Unset, data)

        metric_info = _parse_metric_info(d.pop("metric_info", UNSET))

        def _parse_files(data: object) -> ExtendedSessionRecordFilesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                files_type_0 = ExtendedSessionRecordFilesType0.from_dict(data)

                return files_type_0
            except:  # noqa: E722
                pass
            return cast(ExtendedSessionRecordFilesType0 | None | Unset, data)
