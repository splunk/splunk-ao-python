...
T = TypeVar("T", bound="PartialExtendedWorkflowSpanRecordAnnotationAggregates")
...
class PartialExtendedWorkflowSpanRecordAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        partial_extended_workflow_span_record_annotation_aggregates = cls()
        ...
        partial_extended_workflow_span_record_annotation_aggregates.additional_properties = additional_properties
        return partial_extended_workflow_span_record_annotation_aggregates
