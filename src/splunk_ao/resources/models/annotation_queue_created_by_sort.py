...
T = TypeVar("T", bound="AnnotationQueueCreatedBySort")


@_attrs_define
class AnnotationQueueCreatedBySort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        name = cast(Literal["created_by"] | Unset, d.pop("name", UNSET))
        ...
        annotation_queue_created_by_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        annotation_queue_created_by_sort.additional_properties = d
