...
class CustomizedInputSexistGPTScorer:
    ...
    scorer_name: Literal["_customized_input_sexist_gpt"] | Unset = "_customized_input_sexist_gpt"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Literal["_customized_input_sexist_gpt"] | Unset, d.pop("scorer_name", UNSET))
        ...
        chainpoll_template: Unset | InputSexistTemplate
