...
class CustomizedInputSexistGPTScorer:
    ...
    Attributes:
        ...
        aggregates (CustomizedInputSexistGPTScorerAggregatesType0 | None | Unset):
        aggregate_keys (list[str] | Unset):
        extra (CustomizedInputSexistGPTScorerExtraType0 | None | Unset):
        ...
        chainpoll_template (InputSexistTemplate | Unset): Template for the sexism metric,
        ...
        class_name_to_vocab_ix (CustomizedInputSexistGPTScorerClassNameToVocabIxType0 |
    ...
    aggregates: CustomizedInputSexistGPTScorerAggregatesType0 | None | Unset = UNSET
    aggregate_keys: list[str] | Unset = UNSET
    extra: CustomizedInputSexistGPTScorerExtraType0 | None | Unset = UNSET
    ...
    chainpoll_template: InputSexistTemplate | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_aggregates(data: object) -> CustomizedInputSexistGPTScorerAggregatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_extra(data: object) -> CustomizedInputSexistGPTScorerExtraType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        chainpoll_template: InputSexistTemplate | Unset
