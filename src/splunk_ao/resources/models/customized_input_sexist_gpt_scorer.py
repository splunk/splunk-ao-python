...
if TYPE_CHECKING:
    from ..models.customized_input_sexist_gpt_scorer_aggregates_type_0 import (
        CustomizedInputSexistGPTScorerAggregatesType0,
    )
    from ..models.customized_input_sexist_gpt_scorer_class_name_to_vocab_ix_type_0 import (
        CustomizedInputSexistGPTScorerClassNameToVocabIxType0,
    )
    from ..models.customized_input_sexist_gpt_scorer_class_name_to_vocab_ix_type_1 import (
        CustomizedInputSexistGPTScorerClassNameToVocabIxType1,
    )
    from ..models.customized_input_sexist_gpt_scorer_extra_type_0 import CustomizedInputSexistGPTScorerExtraType0
    from ..models.input_sexist_template import InputSexistTemplate
    from ..models.metadata_filter import MetadataFilter
    from ..models.modality_filter import ModalityFilter
    from ..models.node_name_filter import NodeNameFilter


T = TypeVar("T", bound="CustomizedInputSexistGPTScorer")
...
class CustomizedInputSexistGPTScorer:
    """
    Attributes:
        scorer_name (Union[Literal['_customized_input_sexist_gpt'], Unset]):  Default: '_customized_input_sexist_gpt'.
        ...
        aggregates (Union['CustomizedInputSexistGPTScorerAggregatesType0', None, Unset]):
        aggregate_keys (Union[Unset, list[str]]):
        extra (Union['CustomizedInputSexistGPTScorerExtraType0', None, Unset]):
        ...
        chainpoll_template (Union[Unset, InputSexistTemplate]): Template for the sexism metric,
        ...
        class_name_to_vocab_ix (Union['CustomizedInputSexistGPTScorerClassNameToVocabIxType0',
            'CustomizedInputSexistGPTScorerClassNameToVocabIxType1', None, Unset]):
        scorer_path_name (Union[None, Unset, str]):
    """

    scorer_name: Union[Literal["_customized_input_sexist_gpt"], Unset] = "_customized_input_sexist_gpt"
    ...
    aggregates: Union["CustomizedInputSexistGPTScorerAggregatesType0", None, Unset] = UNSET
    aggregate_keys: Union[Unset, list[str]] = UNSET
    extra: Union["CustomizedInputSexistGPTScorerExtraType0", None, Unset] = UNSET
    ...
    chainpoll_template: Union[Unset, "InputSexistTemplate"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.aggregates, Unset):
            aggregates = UNSET
        elif isinstance(self.aggregates, CustomizedInputSexistGPTScorerAggregatesType0):
        ...
        if isinstance(self.extra, Unset):
            extra = UNSET
        elif isinstance(self.extra, CustomizedInputSexistGPTScorerExtraType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scorer_name = cast(Union[Literal["_customized_input_sexist_gpt"], Unset], d.pop("scorer_name", UNSET))
        if scorer_name != "_customized_input_sexist_gpt" and not isinstance(scorer_name, Unset):
            raise ValueError(f"scorer_name must match const '_customized_input_sexist_gpt', got '{scorer_name}'")
        ...
        def _parse_aggregates(data: object) -> Union["CustomizedInputSexistGPTScorerAggregatesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["CustomizedInputSexistGPTScorerAggregatesType0", None, Unset], data)

        aggregates = _parse_aggregates(d.pop("aggregates", UNSET))

        aggregate_keys = cast(list[str], d.pop("aggregate_keys", UNSET))

        def _parse_extra(data: object) -> Union["CustomizedInputSexistGPTScorerExtraType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["CustomizedInputSexistGPTScorerExtraType0", None, Unset], data)
        ...
        chainpoll_template: Union[Unset, InputSexistTemplate]
        if isinstance(_chainpoll_template, Unset):
            chainpoll_template = UNSET
        else:
            chainpoll_template = InputSexistTemplate.from_dict(_chainpoll_template)
        ...
        customized_input_sexist_gpt_scorer = cls(
        ...
        customized_input_sexist_gpt_scorer.additional_properties = d
        return customized_input_sexist_gpt_scorer
