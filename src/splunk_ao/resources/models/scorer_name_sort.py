...
T = TypeVar("T", bound="ScorerNameSort")
...
class ScorerNameSort:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scorer_name_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        scorer_name_sort.additional_properties = d
        return scorer_name_sort
