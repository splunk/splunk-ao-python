...
class AgenticSessionSuccessTemplate:
    ...
    containing all the info necessary to send the agentic session success prompt.
        ...
        Attributes:
            ...
            metric_description (str | Unset):  Default: 'I have a multi-turn chatbot application where the assistant is an
                agent that has access to tools. I want a metric that assesses whether the session should be considered
                successful, in the sense that the assistant fully answered or resolved all user queries and requests.'.
            value_field_name (str | Unset):  Default: 'ai_answered_all_asks'.
            explanation_field_name (str | Unset): Field name to look for in the chainpoll response, for the explanation.
                Default: 'explanation'.
            template (str | Unset):  Default: 'Here is a the chatbot history:\n```\n{query}\n```\nNow perform the evaluation
                on the chat history as described in the system prompt.'.
            metric_few_shot_examples (list[FewShotExample] | Unset):
            response_schema (AgenticSessionSuccessTemplateResponseSchemaType0 | None | Unset): Response schema for the
                output
    """
    ...
    value_field_name: str | Unset = "ai_answered_all_asks"
    ...
    response_schema: AgenticSessionSuccessTemplateResponseSchemaType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_response_schema(data: object) -> AgenticSessionSuccessTemplateResponseSchemaType0 | None | Unset:
            if data is None:
                return data
