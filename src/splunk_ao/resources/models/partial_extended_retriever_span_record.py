...
if TYPE_CHECKING:
    ...
    from ..models.partial_extended_retriever_span_record_annotation_agreement import (
    ...
    from ..models.partial_extended_retriever_span_record_user_metadata import (
        PartialExtendedRetrieverSpanRecordUserMetadata,
    )


T = TypeVar("T", bound="PartialExtendedRetrieverSpanRecord")
...
class PartialExtendedRetrieverSpanRecord:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: Union[Unset, PartialExtendedRetrieverSpanRecordUserMetadata]
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = PartialExtendedRetrieverSpanRecordUserMetadata.from_dict(_user_metadata)
        ...
        dataset_metadata: Union[Unset, PartialExtendedRetrieverSpanRecordDatasetMetadata]
        ...
        feedback_rating_info: Union[Unset, PartialExtendedRetrieverSpanRecordFeedbackRatingInfo]
        ...
        if isinstance(_annotation_agreement, Unset):
            ...
            annotation_agreement = PartialExtendedRetrieverSpanRecordAnnotationAgreement.from_dict(
        ...
        partial_extended_retriever_span_record = cls(
            type_=type_,
            input_=input_,
        ...
        partial_extended_retriever_span_record.additional_properties = d
        return partial_extended_retriever_span_record
