...
T = TypeVar("T", bound="ScorerUpdatedAtSort")


@_attrs_define
class ScorerUpdatedAtSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scorer_updated_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        scorer_updated_at_sort.additional_properties = d
        return scorer_updated_at_sort
