...
T = TypeVar("T", bound="PromptTemplateNameSort")


@_attrs_define
class PromptTemplateNameSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        prompt_template_name_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        prompt_template_name_sort.additional_properties = d
        return prompt_template_name_sort
