...
class ExtendedAgentSpanRecordWithChildren:
    ...
    Attributes:
        ...
        user_metadata (ExtendedAgentSpanRecordWithChildrenUserMetadata | Unset): Metadata associated with this trace or
            span.
        ...
        dataset_metadata (ExtendedAgentSpanRecordWithChildrenDatasetMetadata | Unset): Metadata from the dataset
        ...
        feedback_rating_info (ExtendedAgentSpanRecordWithChildrenFeedbackRatingInfo | Unset): Feedback information
            related to the record
        annotations (ExtendedAgentSpanRecordWithChildrenAnnotations | Unset): Annotations keyed by template ID and
            annotator ID
        ...
        annotation_aggregates (ExtendedAgentSpanRecordWithChildrenAnnotationAggregates | Unset): Annotation aggregate
            information keyed by template ID
        annotation_agreement (ExtendedAgentSpanRecordWithChildrenAnnotationAgreement | Unset): Annotation agreement
            scores keyed by template ID
        overall_annotation_agreement (ExtendedAgentSpanRecordWithChildrenOverallAnnotationAgreement | Unset): Average
        ...
        metric_info (ExtendedAgentSpanRecordWithChildrenMetricInfoType0 | None | Unset): Detailed information about the
            metrics associated with this trace or span
        files (ExtendedAgentSpanRecordWithChildrenFilesType0 | None | Unset): File metadata keyed by file ID for files
    ...
    user_metadata: ExtendedAgentSpanRecordWithChildrenUserMetadata | Unset = UNSET
    ...
    dataset_metadata: ExtendedAgentSpanRecordWithChildrenDatasetMetadata | Unset = UNSET
    ...
    feedback_rating_info: ExtendedAgentSpanRecordWithChildrenFeedbackRatingInfo | Unset = UNSET
    annotations: ExtendedAgentSpanRecordWithChildrenAnnotations | Unset = UNSET
    file_ids: list[str] | Unset = UNSET
    file_modalities: list[ContentModality] | Unset = UNSET
    annotation_aggregates: ExtendedAgentSpanRecordWithChildrenAnnotationAggregates | Unset = UNSET
    annotation_agreement: ExtendedAgentSpanRecordWithChildrenAnnotationAgreement | Unset = UNSET
    overall_annotation_agreement: ExtendedAgentSpanRecordWithChildrenOverallAnnotationAgreement | Unset = UNSET
    annotation_queue_ids: list[str] | Unset = UNSET
    metric_info: ExtendedAgentSpanRecordWithChildrenMetricInfoType0 | None | Unset = UNSET
    files: ExtendedAgentSpanRecordWithChildrenFilesType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: ExtendedAgentSpanRecordWithChildrenUserMetadata | Unset
        ...
        dataset_metadata: ExtendedAgentSpanRecordWithChildrenDatasetMetadata | Unset
        ...
        feedback_rating_info: ExtendedAgentSpanRecordWithChildrenFeedbackRatingInfo | Unset
        ...
        annotations: ExtendedAgentSpanRecordWithChildrenAnnotations | Unset
        ...
        annotation_aggregates: ExtendedAgentSpanRecordWithChildrenAnnotationAggregates | Unset
        ...
        annotation_agreement: ExtendedAgentSpanRecordWithChildrenAnnotationAgreement | Unset
        ...
        overall_annotation_agreement: ExtendedAgentSpanRecordWithChildrenOverallAnnotationAgreement | Unset
        ...
        def _parse_metric_info(data: object) -> ExtendedAgentSpanRecordWithChildrenMetricInfoType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metric_info_type_0 = ExtendedAgentSpanRecordWithChildrenMetricInfoType0.from_dict(data)

                return metric_info_type_0
            except:  # noqa: E722
                pass
            return cast(ExtendedAgentSpanRecordWithChildrenMetricInfoType0 | None | Unset, data)

        metric_info = _parse_metric_info(d.pop("metric_info", UNSET))

        def _parse_files(data: object) -> ExtendedAgentSpanRecordWithChildrenFilesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                files_type_0 = ExtendedAgentSpanRecordWithChildrenFilesType0.from_dict(data)

                return files_type_0
            except:  # noqa: E722
                pass
            return cast(ExtendedAgentSpanRecordWithChildrenFilesType0 | None | Unset, data)
