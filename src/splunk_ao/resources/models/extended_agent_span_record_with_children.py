...
class ExtendedAgentSpanRecordWithChildren:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: Union[Unset, ExtendedAgentSpanRecordWithChildrenUserMetadata]
        ...
        annotations: Union[Unset, ExtendedAgentSpanRecordWithChildrenAnnotations]
        ...
        annotation_aggregates: Union[Unset, ExtendedAgentSpanRecordWithChildrenAnnotationAggregates]
        ...
        annotation_agreement: Union[Unset, ExtendedAgentSpanRecordWithChildrenAnnotationAgreement]
