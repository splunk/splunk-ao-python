...
T = TypeVar("T", bound="UpdateAnnotationQueueRequest")
...
class UpdateAnnotationQueueRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_name(data: object) -> Union["Name", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                name_type_0 = Name.from_dict(data)
        ...
        update_annotation_queue_request = cls(name=name, description=description)

        update_annotation_queue_request.additional_properties = d
        return update_annotation_queue_request
