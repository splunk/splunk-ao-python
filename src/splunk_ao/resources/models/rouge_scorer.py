...
class RougeScorer:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        name = cast(Union[Literal["rouge"], Unset], d.pop("name", UNSET))
        ...
        rouge_scorer = cls(name=name, filters=filters)
