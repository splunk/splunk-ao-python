...
class InstructionAdherenceTemplate:
    ...
    Attributes:
        metric_system_prompt (str | Unset):  Default: 'The user will provide you with a prompt that was sent to a
            ...
            valid JSON string.'.
        metric_description (str | Unset):  Default: 'I have a chatbot application.\nMy system prompt contains a list of
            instructions for what the chatbot should and should not do in every interaction. I want a metric that checks
            whether the latest response from the chatbot is consistent with the instructions.\n\nThe metric should only
            evaluate the latest message (the response), not the chat history. It should return false only if the latest
            ...
            latest message.'.
        value_field_name (str | Unset):  Default: 'is_consistent'.
    ...
    value_field_name: str | Unset = "is_consistent"
    ...
    response_schema: InstructionAdherenceTemplateResponseSchemaType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_response_schema(data: object) -> InstructionAdherenceTemplateResponseSchemaType0 | None | Unset:
            if data is None:
                return data
