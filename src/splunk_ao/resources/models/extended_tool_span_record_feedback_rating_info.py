...
T = TypeVar("T", bound="ExtendedToolSpanRecordFeedbackRatingInfo")


@_attrs_define
class ExtendedToolSpanRecordFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        extended_tool_span_record_feedback_rating_info = cls()
        ...
        extended_tool_span_record_feedback_rating_info.additional_properties = additional_properties
        return extended_tool_span_record_feedback_rating_info
