...
class ToolSelectionQualityScorer:
    ...
    Attributes:
        ...
        filters (list[MetadataFilter | ModalityFilter | NodeNameFilter] | None | Unset): List of filters to apply to the
            scorer.
        type_ (ToolSelectionQualityScorerType | Unset):  Default: ToolSelectionQualityScorerType.PLUS.
    ...
    type_: ToolSelectionQualityScorerType | Unset = ToolSelectionQualityScorerType.PLUS
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: ToolSelectionQualityScorerType | Unset
