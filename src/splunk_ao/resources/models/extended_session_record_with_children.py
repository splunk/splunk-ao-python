...
class ExtendedSessionRecordWithChildren:
    ...
    Attributes:
        ...
        overall_annotation_agreement (ExtendedSessionRecordWithChildrenOverallAnnotationAgreement | Unset): Average
    ...
    overall_annotation_agreement: ExtendedSessionRecordWithChildrenOverallAnnotationAgreement | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        overall_annotation_agreement: ExtendedSessionRecordWithChildrenOverallAnnotationAgreement | Unset
