...
T = TypeVar("T", bound="HealthScoreResultSecondary")


@_attrs_define
class HealthScoreResultSecondary:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        health_score_result_secondary = cls()
        ...
        health_score_result_secondary.additional_properties = additional_properties
        return health_score_result_secondary
