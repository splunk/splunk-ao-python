...
class TreeChoiceAggregate:
    ...
    Attributes:
        ...
        unrated_count (int):
        feedback_type (Literal['tree_choice'] | Unset):  Default: 'tree_choice'.
    """

    counts: TreeChoiceAggregateCounts
    unrated_count: int
    feedback_type: Literal["tree_choice"] | Unset = "tree_choice"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        feedback_type = cast(Literal["tree_choice"] | Unset, d.pop("feedback_type", UNSET))
