...
class InputSexistTemplate:
    ...
    containing all the info necessary to send the sexism prompt.
        ...
        Attributes:
            ...
            response_schema (InputSexistTemplateResponseSchemaType0 | None | Unset): Response schema for the output
    """
    ...
    response_schema: InputSexistTemplateResponseSchemaType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_response_schema(data: object) -> InputSexistTemplateResponseSchemaType0 | None | Unset:
            if data is None:
                return data
