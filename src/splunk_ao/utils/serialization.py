...
from splunk_ao.utils.dependencies import is_langchain_available, is_langgraph_available, is_proto_plus_available
...
def serialize_datetime(v: dt.datetime) -> str:
    ...
    def _serialize_zoned_datetime(v: dt.datetime) -> str:
        if v.tzinfo is not None and v.tzinfo.tzname(None) == dt.UTC.tzname(None):
