...
from splunk_ao.projects import Project as ProjectRecord
from splunk_ao.projects import ProjectNotFoundError, Projects
from splunk_ao.shared.exceptions import _project_not_found_error, _resolve_project_identifiers
...
def _resolve_project(project_id: str | None, project_name: str | None) -> ProjectRecord:
    ...
    :func:`splunk_ao.shared.exceptions._resolve_project_identifiers`, which matches
    the contract of :meth:`splunk_ao.projects.Projects.get_with_env_fallbacks`.
