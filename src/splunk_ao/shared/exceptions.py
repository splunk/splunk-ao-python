...
def _normalize_identifier(value: str | None) -> str | None:
    ...
    Mirrors the trimming :meth:`splunk_ao.projects.Projects.get` does internally,
...
def _resolve_project_identifiers(project_id: str | None, project_name: str | None) -> tuple[str | None, str | None]:
    ...
    Matches the precedence documented by :meth:`splunk_ao.projects.Projects.get_with_env_fallbacks`
    ...
    context) and :func:`splunk_ao.shared.project_resolver._resolve_project` (uses the
