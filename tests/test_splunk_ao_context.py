...
from splunk_ao.decorator import _experiment_id_context, _agent_stream_context, _project_context
...
def test_nested_context_restoration(
    ...
    with splunk_ao_context(project="project1", agent_stream="log_stream1"):
        ...
        with splunk_ao_context(project="project2", agent_stream="log_stream2"):
            ...
            # Third level context
            with splunk_ao_context(project="project3", agent_stream="log_stream3"):
