...
class TestIntegrationList:
    ...
    @patch("splunk_ao.integration.GalileoPythonConfig.get")
    @patch("splunk_ao.integration.list_available_integrations_integrations_available_get")
...
class TestIntegrationFactoryMethods:
    ...
    @patch("splunk_ao.provider.GalileoPythonConfig.get")
...
class TestProviderModels:
    ...
    @patch("splunk_ao.provider.GalileoPythonConfig.get")
    @patch("splunk_ao.provider.get_available_models_llm_integrations_llm_integration_models_get")
